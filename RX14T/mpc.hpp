...
//=========================================================================//
/*!	@file
	@brief	Multi-Function Pin Controller / マルチファンクションピンコントローラ (RX14T)
	...
	*/
	...
	struct mpc_t {
		...
		*/
		...
		//+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++//
		/*!
			@brief  P0n 端子機能制御レジスタ（P1nPFS）（n = 0 ～ 4）
		*/
		//+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++//
		...
		static inline pfs_ip_t<0x0008'C144> P04PFS;


		//+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++//
		/*!
			@brief  P1n 端子機能制御レジスタ（P1nPFS）（n = 0 ～ 5）
		*/
		//+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++//
		static inline pfs_aip_t<0x0008'C148> P10PFS;
		static inline pfs_aip_t<0x0008'C149> P11PFS;
		static inline pfs_aip_t<0x0008'C14A> P12PFS;
		static inline pfs_aip_t<0x0008'C14B> P13PFS;
		...
		//+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++//
		/*!
			@brief  P2n 端子機能制御レジスタ（P2nPFS）（n = 2 ～ 6）
		*/
		//+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++//
		...
		*/
		//+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++//
		static inline pfs_ap_t<0x0008'C160> P40PFS;
		static inline pfs_ap_t<0x0008'C161> P41PFS;
		static inline pfs_ap_t<0x0008'C162> P42PFS;
		static inline pfs_ap_t<0x0008'C163> P43PFS;
		static inline pfs_ap_t<0x0008'C164> P44PFS;
		static inline pfs_ap_t<0x0008'C165> P45PFS;
		static inline pfs_ap_t<0x0008'C166> P46PFS;
		static inline pfs_ap_t<0x0008'C167> P47PFS;
		...
		*/
		...
		//+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++//
		/*!
			@brief  P9n 端子機能制御レジスタ（P9nPFS）（n = 3 ～ 7）
		*/
		//+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++//
		...
		static inline pfs_ip_t<0x0008'C18F> P97PFS;
		...
		*/
		...
		//+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++//
		/*!
			@brief  PGn 端子機能制御レジスタ（PGnPFS）（n = 7）
		*/
		//+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++//
