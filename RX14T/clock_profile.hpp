...
//=============================================================================//
/*!	@file
	@brief	Clock Profile / クロック・プロファイル (RX14T) @n
			Definition of the frequency to be generated by the clock generator @n
	...
	*/
	...
	struct clock_profile {
		...
		*/
		...
		static constexpr uint32_t   ICLK		=  48'000'000;		///< ICLK 周波数（最大48MHz）
		static constexpr uint32_t   PCLKB		=  48'000'000;		///< PCLKB 周波数（最大48MHz）
		static constexpr uint32_t   PCLKD		=  48'000'000;		///< PCLKD 周波数（最大64MHz）
		static constexpr uint32_t   FCLK		=  48'000'000;		///< FCLK 周波数（最大48MHz）
