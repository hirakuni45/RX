...
/********************************************************************************/
/*
 *  Modified 25 Sep 2014 by Yoshinobu Shishido : Append Reg.Struct(st_cmt0_cmcr, st_rspi_spsr)
 *  Modified 25 Sep 2014 by Yoshinobu Shishido : Append ENUM Table enum_ir(CMT2, TPU2, USB0)
 *  Modified 25 Sep 2014 by Yoshinobu Shishido : Append ENUM Table enum_ipr(CMT2, TPU2, USB0)
 *  Modified 25 Sep 2014 by Yoshinobu Shishido : Append ENUM enum_slib
 *  Modified 25 Sep 2014 by Yoshinobu Shishido : Append #defaine  SLIBXR128~143/SLIB144~207,Selectble Interrupt B(CMT2, TPU2, USB0)
 *  Modified 25 Sep 2014 by Yoshinobu Shishido : Append #pragma interrupt SLIBXR_Identifier SLIB
 *
 */
...
*/
    unsigned short CFIFO; //modified from original iodefine
...
*/
    unsigned short D0FIFO; //modified from original iodefine
...
*/
    unsigned short D1FIFO; //modified from original iodefine
...
// KAEDE
IR_CMT2_CMI2=128,
IR_TPU2_TGI2A=129,IR_TPU2_TGI2B=130,IR_TPU2_TCI2V=131,IR_TPU2_TCI2U=132,
IR_TPU5_TGI5A=133,IR_TPU5_TGI5B=134,IR_TPU5_TCI5V=135,IR_TPU5_TCI5U=136,
IR_USB0_USBI0=137,
IR_TPU1_TGI1A=138,
IR_RTC0_CUP=139,
// KAEDE
...
// KAEDE
IER_CMT2_CMI2=0x10,
IER_TPU2_TGI2A=0x10,IER_TPU2_TGI2B=0x10,IER_TPU2_TCI2V=0x10,IER_TPU2_TCI2U=0x10,
IER_TPU5_TGI5A=0x10,IER_TPU5_TGI5B=0x10,IER_TPU5_TCI5V=0x10,IER_TPU5_TCI5U=0x11,
IER_USB0_USBI0=0x11,
IER_TPU1_TGI1A=0x11,
IER_RTC0_CUP=0x11
// KAEDE
...
// KAEDE
IPR_CMT2_CMI2=128,
IPR_TPU2_TGI2A=129,IPR_TPU2_TGI2B=130,IPR_TPU2_TCI2V=131,IPR_TPU2_TCI2U=132,
IPR_TPU5_TGI5A=133,IPR_TPU5_TGI5B=134,IPR_TPU5_TCI5V=135,IPR_TPU5_TCI5U=136,
IPR_USB0_USBI0=137,
IPR_TPU1_TGI1A=138,
IPR_RTC0_CUP=139
// KAEDE
...
// KAEDE
// Selectble Interrupt B
enum enum_slib{
SLIB_CMT2_CMI2=1,
SLIB_TPU1_TGI1A=20,SLIB_TPU1_TGI1B=21,SLIB_TPU1_TCI1V=22,SLIB_TPU1_TCI1U=23,
SLIB_TPU2_TGI2A=24,SLIB_TPU2_TGI2B=25,SLIB_TPU2_TCI2V=26,SLIB_TPU2_TCI2U=27,
SLIB_TPU5_TGI5A=37,SLIB_TPU5_TGI5B=38,SLIB_TPU5_TCI5V=39,SLIB_TPU5_TCI5U=40,
SLIB_USB0_USBI0=62,
SLIB_RTC0_CUP=49
};

#define SLIBXR128   ICU.SLIBXR128.BYTE  // CMT2 CMI2
#define SLIBXR129   ICU.SLIBXR129.BYTE  // TPU2 TGI2A
#define SLIBXR130   ICU.SLIBXR130.BYTE  // TPU2 TGI2B
#define SLIBXR131   ICU.SLIBXR131.BYTE  // TPU2 TCI2V
#define SLIBXR132   ICU.SLIBXR132.BYTE  // TPU2 TCI2U
#define SLIBXR133   ICU.SLIBXR133.BYTE  // TPU5 TGI5A
#define SLIBXR134   ICU.SLIBXR134.BYTE  // TPU5 TGI5B
#define SLIBXR135   ICU.SLIBXR135.BYTE  // TPU5 TCI5V
#define SLIBXR136   ICU.SLIBXR136.BYTE  // TPU5 TCI5U
#define SLIBXR137   ICU.SLIBXR137.BYTE  // USB0 USBI0
#define SLIBXR138   ICU.SLIBXR138.BYTE  // TPU1 TGI1A
#define SLIBXR139   ICU.SLIBXR139.BYTE  // RTC0 CUP
#define SLIBXR140   ICU.SLIBXR140.BYTE
#define SLIBXR141   ICU.SLIBXR141.BYTE
#define SLIBXR142   ICU.SLIBXR142.BYTE
#define SLIBXR143   ICU.SLIBXR143.BYTE
#define SLIBR144    ICU.SLIBR144.BYTE
#define SLIBR145    ICU.SLIBR145.BYTE
#define SLIBR146    ICU.SLIBR146.BYTE
#define SLIBR137    ICU.SLIBR147.BYTE
#define SLIBR138    ICU.SLIBR138.BYTE
#define SLIBR139    ICU.SLIBR139.BYTE
#define SLIBR140    ICU.SLIBR140.BYTE
#define SLIBR141    ICU.SLIBR141.BYTE
#define SLIBR142    ICU.SLIBR142.BYTE
#define SLIBR143    ICU.SLIBR143.BYTE
#define SLIBR144    ICU.SLIBR144.BYTE
#define SLIBR145    ICU.SLIBR145.BYTE
#define SLIBR146    ICU.SLIBR146.BYTE
#define SLIBR147    ICU.SLIBR147.BYTE
#define SLIBR148    ICU.SLIBR148.BYTE
#define SLIBR149    ICU.SLIBR149.BYTE
#define SLIBR150    ICU.SLIBR150.BYTE
#define SLIBR151    ICU.SLIBR151.BYTE
#define SLIBR152    ICU.SLIBR152.BYTE
#define SLIBR153    ICU.SLIBR153.BYTE
#define SLIBR154    ICU.SLIBR154.BYTE
#define SLIBR155    ICU.SLIBR155.BYTE
#define SLIBR156    ICU.SLIBR156.BYTE
#define SLIBR157    ICU.SLIBR157.BYTE
#define SLIBR158    ICU.SLIBR158.BYTE
#define SLIBR159    ICU.SLIBR159.BYTE
#define SLIBR160    ICU.SLIBR160.BYTE
#define SLIBR161    ICU.SLIBR161.BYTE
#define SLIBR162    ICU.SLIBR162.BYTE
#define SLIBR163    ICU.SLIBR163.BYTE
#define SLIBR164    ICU.SLIBR164.BYTE
#define SLIBR165    ICU.SLIBR165.BYTE
#define SLIBR166    ICU.SLIBR166.BYTE
#define SLIBR167    ICU.SLIBR167.BYTE
#define SLIBR168    ICU.SLIBR168.BYTE
#define SLIBR169    ICU.SLIBR169.BYTE
#define SLIBR170    ICU.SLIBR170.BYTE
#define SLIBR171    ICU.SLIBR171.BYTE
#define SLIBR172    ICU.SLIBR172.BYTE
#define SLIBR173    ICU.SLIBR173.BYTE
#define SLIBR174    ICU.SLIBR174.BYTE
#define SLIBR175    ICU.SLIBR175.BYTE
#define SLIBR176    ICU.SLIBR176.BYTE
#define SLIBR177    ICU.SLIBR177.BYTE
#define SLIBR178    ICU.SLIBR178.BYTE
#define SLIBR179    ICU.SLIBR179.BYTE
#define SLIBR180    ICU.SLIBR180.BYTE
#define SLIBR181    ICU.SLIBR181.BYTE
#define SLIBR182    ICU.SLIBR182.BYTE
#define SLIBR183    ICU.SLIBR183.BYTE
#define SLIBR184    ICU.SLIBR184.BYTE
#define SLIBR185    ICU.SLIBR185.BYTE
#define SLIBR186    ICU.SLIBR186.BYTE
#define SLIBR187    ICU.SLIBR187.BYTE
#define SLIBR188    ICU.SLIBR188.BYTE
#define SLIBR189    ICU.SLIBR189.BYTE
#define SLIBR190    ICU.SLIBR190.BYTE
#define SLIBR191    ICU.SLIBR191.BYTE
#define SLIBR192    ICU.SLIBR192.BYTE
#define SLIBR193    ICU.SLIBR193.BYTE
#define SLIBR194    ICU.SLIBR194.BYTE
#define SLIBR195    ICU.SLIBR195.BYTE
#define SLIBR196    ICU.SLIBR196.BYTE
#define SLIBR197    ICU.SLIBR197.BYTE
#define SLIBR198    ICU.SLIBR198.BYTE
#define SLIBR199    ICU.SLIBR199.BYTE
#define SLIBR200    ICU.SLIBR200.BYTE
#define SLIBR201    ICU.SLIBR201.BYTE
#define SLIBR202    ICU.SLIBR202.BYTE
#define SLIBR203    ICU.SLIBR203.BYTE
#define SLIBR204    ICU.SLIBR204.BYTE
#define SLIBR205    ICU.SLIBR205.BYTE
#define SLIBR206    ICU.SLIBR206.BYTE
#define SLIBR207    ICU.SLIBR207.BYTE
// KAEDE
...
#define	IEN_PERIB_INTB128	IEN0        // CMT2 CMI2
#define	IEN_PERIB_INTB129	IEN1        // TPU2 TGI2A
#define	IEN_PERIB_INTB130	IEN2        // TPU2 TGI2B
#define	IEN_PERIB_INTB131	IEN3        // TPU2 TCI2V
#define	IEN_PERIB_INTB132	IEN4        // TPU2 TCI2U
#define	IEN_PERIB_INTB133	IEN5        // TPU5 TGI5A
#define	IEN_PERIB_INTB134	IEN6        // TPU5 TGI5B
#define	IEN_PERIB_INTB135	IEN7        // TPU5 TCI5V
#define	IEN_PERIB_INTB136	IEN0        // TPU5 TCI5U
#define	IEN_PERIB_INTB137	IEN1        // USB0 USBI0
#define	IEN_PERIB_INTB138	IEN2
#define	IEN_PERIB_INTB139	IEN3        // RTC0 CUP
...
// KAEDE
// Selectble Interrupt B
#define IEN_CMT2_CMI2       IEN0
#define IEN_TPU2_TGI2A      IEN1
#define IEN_TPU2_TGI2B      IEN2
#define IEN_TPU2_TCI2V      IEN3
#define IEN_TPU2_TCI2U      IEN4
#define IEN_TPU5_TGI5A      IEN5
#define IEN_TPU5_TGI5B      IEN6
#define IEN_TPU5_TCI5V      IEN7
#define IEN_TPU5_TCI5U      IEN0
#define IEN_USB0_USBI0      IEN1
#define IEN_TPU1_TGI1A      IEN2
#define IEN_RTC0_CUP        IEN3
// KAEDE
...
// KAEDE
#define __SLIB( x )      SLIB ## x
#define  _SLIB( x )      __SLIB( x )
#define   SLIBNO( x , y )  _SLIB( _ ## x ## _ ## y )
// KAEDE
