...
/*!	@file
	@brief	RX グループ・MTU2a 定義 @n
			RX110/RX111/RX113 @n
			RX130/RX140 @n
			RX210/RX21A/RX220/RX230/RX231 @n
			RX23W @n
			RX631/RX63N 
...
#if defined(SIG_RX110) || defined(SIG_RX111) || defined(SIG_RX113) || defined(SIG_RX130) || defined(SIG_RX140) || defined(SIG_RX210) || defined(SIG_RX21A) || defined(SIG_RX220) || defined(SIG_RX631) || defined(SIG_RX63N)
	...
	*/
	...
	struct mtu4_t : public mtu_base_t, MTU, MTUA {
		...
		*/
		...
		//-----------------------------------------------------------------//
		/*!
			@brief	タイマ I/O コントロールレジスタ（TIORH） @n
					※正式な名称は「TIOR」レジスタ
		*/
		//-----------------------------------------------------------------//
...
#elif defined(SIG_RX111) || defined(SIG_RX113) || defined(SIG_RX130) || defined(SIG_RX140) || defined(SIG_RX210) || defined(SIG_RX21A) || defined(SIG_RX220)
	typedef mtu0_t<0x0008'8700, 0x0008'8690, ICU::VECTOR, ICU::VECTOR> MTU0;
	typedef mtu1_t<0x0008'8780, 0x0008'8691, ICU::VECTOR, ICU::VECTOR> MTU1;
	typedef mtu2_t<0x0008'8800, 0x0008'8692, ICU::VECTOR, ICU::VECTOR> MTU2;
