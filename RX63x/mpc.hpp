...
namespace device {
	...
	*/
	...
	struct mpc_t {
		...
		*/
		//+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++//
		static inline pfs_aip_t<0x0008'C140> P00PFS;
		static inline pfs_aip_t<0x0008'C141> P01PFS;
		static inline pfs_aip_t<0x0008'C142> P02PFS;
		static inline pfs_aip_t<0x0008'C143> P03PFS;
		static inline pfs_aip_t<0x0008'C145> P05PFS;
		static inline pfs_aip_t<0x0008'C147> P07PFS;
		...
		*/
		...
		static inline pfs_ip_t<0x0008'C157> P27PFS;
		...
		*/
		//+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++//
		static inline pfs_ai_t<0x0008'C160> P40PFS;
		static inline pfs_ai_t<0x0008'C161> P41PFS;
		static inline pfs_ai_t<0x0008'C162> P42PFS;
		static inline pfs_ai_t<0x0008'C163> P43PFS;
		static inline pfs_ai_t<0x0008'C164> P44PFS;
		static inline pfs_ai_t<0x0008'C165> P45PFS;
		static inline pfs_ai_t<0x0008'C166> P46PFS;
		static inline pfs_ai_t<0x0008'C167> P47PFS;
		...
		*/
		...
		static inline pfs_ip_t<0x0008'C16F> P57PFS;
		...
		*/
		//+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++//
		static inline pfs_ip_t<0x0008'C170> P60PFS;
		static inline pfs_ip_t<0x0008'C171> P61PFS;
		static inline pfs_ip_t<0x0008'C176> P66PFS;
		static inline pfs_ip_t<0x0008'C177> P67PFS;
		...
		*/
		//+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++//
		static inline pfs_ap_t<0x0008'C188> P90PFS;
		static inline pfs_ap_t<0x0008'C189> P91PFS;
		static inline pfs_ap_t<0x0008'C18A> P92PFS;
		static inline pfs_ap_t<0x0008'C18B> P93PFS;
		...
		*/
		...
		static inline pfs_ip_t<0x0008'C1BD> PF5PFS;
		...
		*/
		...
		static inline pfusb1_t<0x0008'C115> PFUSB1;
	};
	typedef mpc_t MPC;
}
