	...
	*/
	...
	class port_map : public port_map_order {
		...
		static bool riic3_(ORDER odr, bool enable) noexcept
		{
			...
			switch(odr) {
			case ORDER::FIRST:
			// SCL3: PC0 (LFQFP144:  75)
			// SDA3: PC1 (LFQFP144:  73)
				PORTC::PMR.B0 = 0;
		...
		static bool can1_(ORDER odr, bool enable) noexcept
		{
			...
			switch(odr) {
			case ORDER::FIRST:
			// CRX1: P15 (LFQFP144:  42)
			// CTX1: P14 (LFQFP144:  43)
				PORT1::PMR.B5 = 0;
				MPC::P15PFS.PSEL = sel;  // ok
				PORT1::PMR.B5 = enable;
				PORT1::PMR.B4 = 0;
				...
				break;
			case ORDER::SECOND:
			// CRX1: P55 (LFQFP144:  51)
			// CTX1: P54 (LFQFP144:  52)
				PORT5::PMR.B5 = 0;
		...
		static bool can2_(ORDER odr, bool enable) noexcept
		{
			...
			// CRX2: P67 (LFQFP144:  98)
			// CTX2: P66 (LFQFP144:  99)
				PORT6::PMR.B7 = 0;
		...
		static bool rspi0_(ORDER odr, bool enable) noexcept
		{
			...
			// MISOA:  PA7 (LFQFP144:  88)
				...
				break;
			case ORDER::SECOND:
			// RSPCKA: PB0 (LFQFP144:  87)
			// MOSIA:  P16 (LFQFP144:  40)
			// MISOA:  P17 (LFQFP144:  38)
				PORTB::PMR.B0 = 0;
				MPC::PB0PFS.PSEL = sel;  // ok
				PORTB::PMR.B0 = enable;
				PORT1::PMR.B6 = 0;
		...
		static bool rspi1_(ORDER odr, bool enable) noexcept
		{
			...
			switch(odr) {
			case ORDER::FIRST:
			// RSPCKB: P27 (LFQFP144:  30)
			// MOSIB:  P26 (LFQFP144:  31)
			// MISOB:  P30 (LFQFP144:  29)
				PORT2::PMR.B7 = 0;
				MPC::P27PFS.PSEL = sel;  // ok
				PORT2::PMR.B7 = enable;
				PORT2::PMR.B6 = 0;
				...
				break;
			case ORDER::SECOND:
			// RSPCKB: PE1 (LFQFP144: 110)
			// MOSIB:  PE2 (LFQFP144: 109)
			// MISOB:  PE3 (LFQFP144: 108)
				PORTE::PMR.B1 = 0;
				MPC::PE1PFS.PSEL = sel;  // ok
				PORTE::PMR.B1 = enable;
				PORTE::PMR.B2 = 0;
				...
				break;
			case ORDER::THIRD:
			// RSPCKB: PE5 (LFQFP144: 106)
			// MOSIB:  PE6 (LFQFP144: 102)
			// MISOB:  PE7 (LFQFP144: 101)
				PORTE::PMR.B5 = 0;
		...
		static bool rspi1_ssl_(RSPI ssl, ORDER odr, bool enable) noexcept
		{
			...
			case RSPI::SSL1:
				...
				break;
			case RSPI::SSL2:
				// SSLB2: P51 (LFQFP144:  55)
				// SSLB2: PE1 (LFQFP144: 110)
				if(odr == ORDER::FIRST) {
					PORT5::PMR.B1 = 0;
					MPC::P51PFS.PSEL = sel;
					PORT5::PMR.B1 = enable;
				...
				break;
			case RSPI::SSL3:
				// SSLB3: P52 (LFQFP144:  54)
				// SSLB3: PE2 (LFQFP144: 109)
				if(odr == ORDER::FIRST) {
					PORT5::PMR.B2 = 0;
					MPC::P52PFS.PSEL = sel;
					PORT5::PMR.B2 = enable;
		...
		static bool rspi2_(ORDER odr, bool enable) noexcept
		{
			...
			switch(odr) {
			case ORDER::FIRST:
			// RSPCKC: PD3 (LFQFP144: 123)
			// MOSIC:  PD1 (LFQFP144: 125)
			// MISOC:  PD2 (LFQFP144: 124)
				PORTD::PMR.B3 = 0;
