	...
	*/
	...
	class port_map : public port_map_order {
		...
		static bool sci1_(ORDER odr, bool enable, OPTIONAL opt) noexcept
		{
			...
			// RXD1: PF2 (LFQFP100: ---) (LFQFP144: ---)
			// TXD1: PF0 (LFQFP100: ---) (LFQFP144: ---)
			// SCK1: PF1 (LFQFP100: ---) (LFQFP144: ---)
				PORTF::PMR.B2 = 0;
				PORTF::ODR.B2 = i2c;
		...
		static bool riic3_(ORDER odr, bool enable) noexcept
		{
			...
			switch(odr) {
			case ORDER::FIRST:
			// SCL3: PC0 (LFQFP100:  52) (LFQFP144:  75)
			// SDA3: PC1 (LFQFP100:  51) (LFQFP144:  73)
				PORTC::PMR.B0 = 0;
		...
		static bool can1_(ORDER odr, bool enable) noexcept
		{
			...
			switch(odr) {
			case ORDER::FIRST:
			// CRX1: P15 (LFQFP100:  31) (LFQFP144:  42)
		...
		static bool can2_(ORDER odr, bool enable) noexcept
		{
			...
			// CRX2: P67 (LFQFP100: ---) (LFQFP144:  98)
			// CTX2: P66 (LFQFP100: ---) (LFQFP144:  99)
				PORT6::PMR.B7 = 0;
		...
		static bool rspi0_(ORDER odr, bool enable) noexcept
		{
			...
			// MISOA:  PA7 (LFQFP100:  63) (LFQFP144:  88)
				...
				break;
			case ORDER::SECOND:
			// RSPCKA: PB0 (LFQFP100:  61) (LFQFP144:  87)
			// MOSIA:  P16 (LFQFP100:  30) (LFQFP144:  40)
			// MISOA:  P17 (LFQFP100:  29) (LFQFP144:  38)
				PORTB::PMR.B0 = 0;
				MPC::PB0PFS.PSEL = sel;  // ok
				PORTB::PMR.B0 = enable;
				PORT1::PMR.B6 = 0;
		...
		static bool rspi1_(ORDER odr, bool enable) noexcept
		{
			...
			// MISOB:  P30 (LFQFP100:  20) (LFQFP144:  29)
				...
				break;
			case ORDER::SECOND:
			// RSPCKB: PE1 (LFQFP100:  77) (LFQFP144: 110)
			// MOSIB:  PE2 (LFQFP100:  76) (LFQFP144: 109)
			// MISOB:  PE3 (LFQFP100:  75) (LFQFP144: 108)
				PORTE::PMR.B1 = 0;
				MPC::PE1PFS.PSEL = sel;  // ok
				PORTE::PMR.B1 = enable;
				PORTE::PMR.B2 = 0;
		...
		static bool rspi2_(ORDER odr, bool enable) noexcept
		{
			...
			switch(odr) {
			case ORDER::FIRST:
			// RSPCKC: PD3 (LFQFP100:  83) (LFQFP144: 123)
			// MOSIC:  PD1 (LFQFP100:  85) (LFQFP144: 125)
			// MISOC:  PD2 (LFQFP100:  84) (LFQFP144: 124)
				PORTD::PMR.B3 = 0;
