		...
		*/
		...
		static bool turn_usb(USB_PORT sel, bool ena = true, ORDER odr = ORDER::FIRST) noexcept
		{
			...
			case USB_PORT::VBUSEN:
				...
				// P26 (LFQFP100: ---) (LFQFP144: ---) (LFQFP176: ---)
			...
			case USB_PORT::DPUPE:
				...
				case ORDER::SECOND:
					PORT2::PMR.B3 = 0;
					MPC::P23PFS.PSEL = ena ? 0b01'0011 : 0;  // ok
					PORT2::PMR.B3 = ena;
					break;
				case ORDER::THIRD:
					PORT3::PMR.B1 = 0;
					MPC::P31PFS.PSEL = ena ? 0b01'0011 : 0;  // ok
					PORT3::PMR.B1 = ena;
					break;
				default:
					ret = false;
			...
			case USB_PORT::DPRPD:
				...
				case ORDER::FIRST:
					PORT2::PMR.B5 = 0;
					MPC::P25PFS.PSEL = ena ? 0b01'0011 : 0;  // ok
					PORT2::PMR.B5 = ena;
					break;
				case ORDER::SECOND:
					PORT3::PMR.B4 = 0;
					MPC::P34PFS.PSEL = ena ? 0b01'0011 : 0;  // ok
					PORT3::PMR.B4 = ena;
					break;
				case ORDER::THIRD:
					PORTC::PMR.B4 = 0;
					MPC::PC4PFS.PSEL = ena ? 0b01'0011 : 0;  // ok
					PORTC::PMR.B4 = ena;
					break;
				default:
					ret = false;
			...
			case USB_PORT::DRPD:
				// P22 (LFQFP100:  25) (LFQFP144:  35) (LFQFP176:  43)
				...
				case ORDER::SECOND:
					PORT3::PMR.B0 = 0;
					MPC::P30PFS.PSEL = ena ? 0b01'0011 : 0;  // ok
					PORT3::PMR.B0 = ena;
					break;
				default:
					ret = false;
		...
		*/
		...
		static bool turn_usb1(USB_PORT sel, bool ena = true, ORDER odr = ORDER::FIRST) noexcept
		{
			...
			case USB_PORT::VBUS:
				...
				case ORDER::FIRST:
					PORT1::PMR.B7 = 0;
					MPC::P17PFS.PSEL = ena ? 0b01'0001 : 0;  // ok
					PORT1::PMR.B7 = ena;
					break;
				default:
					ret = false;
			...
			case USB_PORT::DPUPE:
				...
				case ORDER::FIRST:
					PORT1::PMR.B5 = 0;
					MPC::P15PFS.PSEL = ena ? 0b01'0001 : 0;  // ok
					PORT1::PMR.B5 = ena;
					break;
				default:
					ret = false;
