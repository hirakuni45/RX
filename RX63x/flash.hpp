...
//=========================================================================//
/*!	@file
	@brief	RX631/RX63N グループ・フラッシュ 定義
	...
	*/
	...
	struct flash_t {
		...
		*/
		//-----------------------------------------------------------------//
#ifdef G_VERSION
		typedef ro32_t<0xFEFF'FAC0> UIDR0_;
		typedef ro32_t<0xFEFF'FAC4> UIDR1_;
		typedef ro32_t<0xFEFF'FAC8> UIDR2_;
		typedef ro32_t<0xFEFF'FACC> UIDR3_;
#else
