...
- [device.hpp (SIG_RX26T)](../common/device.hpp?ts=4)
- [renesas.hpp (SIG_RX26T)](../common/renesas.hpp?ts=4)

|name space|Device, Renesas|デバイス、ルネサス|
|---|---|---|
|[clock_profile](../RX26T/clock_profile?ts=4)|Clock Profile|クロック・プロファイル|
|[SYSTEM](../RX26T/system.hpp?ts=4)|Clock Generation Circuit|クロック発生回路|
|[power_mgr](../RX26T/power_mgr.hpp?ts=4)|Low Power Consumption|消費電力低減機能|
|[ICU](../RX26T/icu.hpp?ts=4)|Interrupt Controller|割り込みコントローラ|
|[icu_mgr](../RX26T/icu_mgr.hpp?ts=4)|ICU Manager|ICU マネージャー|
|[MPC](../RX26T/mpc.hpp?ts=4)|Multi-Function Pin Controller|マルチファンクションピンコントローラ|
|[PORTx](../RX26T/port.hpp?ts=4)|I/O Ports|I/O ポート|
|[port_map](../RX26T/port_map.hpp?ts=4)|Port Mapping|ポート・マッピング|
|[port_map_mtu](../RX26T/port_map_mtu.hpp?ts=4)|Port Mapping MTU|ポート・マッピング MTU|
|[port_map_gpt](../RX26T/port_map_gpt.hpp?ts=4)|Port Mapping GPT|ポート・マッピング GPT|
|[port_map_tmr](../RX26T/port_map_tmr.hpp?ts=4)|Port Mapping TMR|ポート・マッピング TMR|
|[port_map_irq](../RX26T/port_map_irq.hpp?ts=4)|Port Mapping IRQ|ポート・マッピング IRQ|
|[FLASH](../RX26T/flash.hpp?ts=4)|Flash Memory|フラッシュメモリ|
|[SYSTEM_IO](../RX26T/system_io.hpp?ts=4)|System In/Out (Clock Setting)|システム In/Out (クロック設定)|
...
|[board_profile](../RX26T/board_profile?ts=4)|Board Profile|ボード・プロファイル|
...
|[POE3D](../RX600/poe3d.hpp?ts=4)|Port Output Enable 3D|ポートアウトプットイネーブル３Ｄ|
...
|[RI3C0](../RX600/ri3c.hpp?ts=4)|I3C-bus Interface 0|I3C バスインタフェース０|
...
|[RSPIA0](../RX600/rspia.hpp?ts=4)|Serial Peripheral Interface A0|シリアルペリフェラルインタフェースＡ０|
|[CRC](../RX600/crc.hpp?ts=4)|CRC Calculator|CRC 演算器|
|TSIP_L|Trusted Secure IP (TSIP-Lite)|Trusted Secure IP (TSIP-Lite)|
|[S12AD](../RX26T/s12adh.hpp?ts=4)|12-Bit A/D Converter|12 ビット A/D コンバータ|
|[S12AD1](../RX26T/s12adh.hpp?ts=4)|12-Bit A/D Converter 1|12 ビット A/D コンバータ１|
|[S12AD2](../RX26T/s12adh.hpp?ts=4)|12-Bit A/D Converter 2|12 ビット A/D コンバータ２|
