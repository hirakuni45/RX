...
namespace device {
	...
	typedef portx_t<0x0008'C001, odr_ox_t<0x0008'C082> > PORT1;
	...
	typedef portx_t<0x0008'C00C, odr_ox_t<0x0008'C098> > PORTC;
	typedef portx_t<0x0008'C00D, odr_oo_t<0x0008'C09A> > PORTD;
	typedef portx_t<0x0008'C00E, odr_oo_t<0x0008'C09C> > PORTE;
	
	typedef portx_t<0x0008'C016, odr_xo_t<0x0008'C0A0> > PORTN;
}
