	...
	*/
	...
	struct s12adh_base_t {
		...
		*/
		...
		typedef adgctrgr2_t<base + 0xDC>  ADGCTRGR2_;
		static  ADGCTRGR2_ ADGCTRGR2;
	...
	template <uint32_t base> typename s12adh_base_t<base>::ADGCTRGR2_ s12adh_base_t<base>::ADGCTRGR2;
