...
- [device.hpp (SIG_RX24U)](../common/device.hpp?ts=4)
- [renesas.hpp (SIG_RX24U)](../common/renesas.hpp?ts=4)

|name space|Device, Renesas|デバイス、ルネサス|
|---|---|---|
|[clock_profile](../RX24U/clock_profile?ts=4)|Clock Profile|クロック・プロファイル|
...
|[ICU](../RX24U/icu.hpp?ts=4)|Interrupt Controller|割り込みコントローラ|
|[icu_mgr](../RX24T/icu_mgr.hpp?ts=4)|ICU Manager|ICU マネージャー|
|[MPC](../RX24U/mpc.hpp?ts=4)|Multi-Function Pin Controller|マルチファンクションピンコントローラ|
|[PORTx](../RX24U/port.hpp?ts=4)|I/O Ports|I/O ポート|
|[port_map](../RX24U/port_map.hpp?ts=4)|Port Mapping|ポート・マッピング|
|[port_map_mtu](../RX24U/port_map_mtu.hpp?ts=4)|Port Mapping MTU|ポート・マッピング MTU|
|[port_map_gpt](../RX24U/port_map_gpt.hpp?ts=4)|Port Mapping GPT|ポート・マッピング GPT|
|[port_map_tmr](../RX24U/port_map_tmr.hpp?ts=4)|Port Mapping TMR|ポート・マッピング TMR|
|[port_map_irq](../RX24U/port_map_irq.hpp?ts=4)|Port Mapping IRQ|ポート・マッピング IRQ|
...
|[board_profile](../RX24U/board_profile?ts=4)|Board Profile|ボード・プロファイル|
...
|[POE3](../RX24T/poe3.hpp?ts=4)|Port Output Enable 3|ポートアウトプットイネーブル３|
