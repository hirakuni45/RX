...
#else
		static constexpr uint32_t	PLL_BASE	= 252'000'000;		///< PLL ベースクロック（最大240MHz）

		static constexpr uint32_t	ICLK		= 252'000'000;		///< ICLK 周波数（最大240MHz）
		static constexpr uint32_t	PCLKA		= 126'000'000;		///< PCLKA 周波数（最大120MHz）
		static constexpr uint32_t	PCLKB		=  63'000'000;		///< PCLKB 周波数（最大60MHz）
		static constexpr uint32_t	PCLKC		=  63'000'000;		///< PCLKC 周波数（最大60MHz）
		static constexpr uint32_t	PCLKD		=  63'000'000;		///< PCLKD 周波数（最大60MHz）
		static constexpr uint32_t	FCLK		=  63'000'000;		///< FCLK 周波数（最大60MHz）
		static constexpr uint32_t	BCLK		= 126'000'000;		///< BCLK 周波数（最大120MHz）
#endif
