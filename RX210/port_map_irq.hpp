...
//=========================================================================//
/*!	@file
	@brief	RX210 グループ・ポート・マッピング (IRQ)
...
namespace device {
	...
	*/
	...
	class port_map_irq : public port_map_order {
		...
		{
			switch(odr) {  // IRQ4:
			// PB1 (DS) (LFQFP64: 37) (LFQFP100:  59)
			// P14      (LFQFP64: 20) (LFQFP100:  32)
			// P34      (LFQFP64: --) (LFQFP100:  18)
			// PD4      (LFQFP64: --) (LFQFP100:  82)
			// PF5      (LFQFP64: --) (LFQFP100: ---)
			case ORDER::FIRST:
				PORTB::PMR.B1 = 0;
				MPC::PB1PFS.PSEL = 0;
				MPC::PB1PFS.ISEL = ena;
