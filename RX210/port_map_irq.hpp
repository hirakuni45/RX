...
namespace device {
	...
	*/
	...
	class port_map_irq : public port_map_order {
		...
		{
			switch(odr) {  // IRQ4:
			// PB1 (DS) (LQFP64: 37) (LQFP100:  59)
			// P14      (LQFP64: 20) (LQFP100:  32)
			// P34      (LQFP64: --) (LQFP100:  18)
