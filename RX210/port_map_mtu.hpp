...
//=========================================================================//
/*!	@file
	@brief	RX210 グループ・ポート・マッピング (MTU2a)
	...
	*/
	...
	public:
		...
		/*!
			...
			@param[in]	odr	候補選択
			@param[in]	neg	反転入出力の場合「true」（RX210 では未サポート）
