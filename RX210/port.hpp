...
namespace device {
	...
	typedef portx_t<0x0008'C006, odr_ox_t<0x0008'C08C> > PORT6;
	typedef portx_t<0x0008'C007, odr_oo_t<0x0008'C08E> > PORT7;
	typedef portx_t<0x0008'C008, odr_ox_t<0x0008'C090> > PORT8;
	typedef portx_t<0x0008'C009, odr_ox_t<0x0008'C092> > PORT9;
	...
	typedef portx_t<0x0008'C00F, odr_xx_t<0x0008'C09E> > PORTF;
	...
	typedef portx_t<0x0008'C014, odr_xx_t<0x0008'C0A8> > PORTL;
