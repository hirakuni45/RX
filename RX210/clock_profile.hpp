...
//=========================================================================//
/*!	@file
	@brief	RX210 グループ・クロック。プロファイル @n
            クロックジェネレータで発生させる周波数の定義 @n
			外部クロック入力でも最大は 20MHz となる。
	...
	*/
	...
	public:
		...
		*/
		...
		static constexpr uint32_t   PCLKB		= 25'000'000;		///< PCLKB 周波数（最大32MHz）
		static constexpr uint32_t   PCLKD		= 50'000'000;		///< PCLKD 周波数（最大50MHz）
