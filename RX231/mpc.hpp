...
//=========================================================================//
/*!	@file
	@brief	Multi-Function Pin Controller / マルチファンクションピンコントローラ (RX230/RX231)
...
namespace device {
	...
	*/
	...
	struct mpc_t {
		...
		*/
		//+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++//
		static inline pfs_ap_t<0x0008'C150> P20PFS;
		static inline pfs_ap_t<0x0008'C151> P21PFS;
		static inline pfs_ap_t<0x0008'C152> P22PFS;
		static inline pfs_ap_t<0x0008'C153> P23PFS;
		static inline pfs_ap_t<0x0008'C154> P24PFS;
		...
		*/
		...
		static inline pfs_p_t<0x0008'C16B> P53PFS;
