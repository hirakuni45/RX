...
#else
	typedef edmac_t<0x000C'0000, peripheral::EDMAC0, ICU::VECTOR_AL1, ICU::VECTOR_AL1::EINT0> EDMAC0;
#endif
#if defined(SIG_RX64M) || defined(SIG_RX71M) || defined(SIG_RX72N) || defined(SIG_RX72M)
	typedef edmac_t<0x000C'0200, peripheral::EDMAC1, ICU::VECTOR_AL1, ICU::VECTOR_AL1::EINT1> EDMAC1;
