	...
	public:
		...
		*/
		...
		static bool set_level(ICU::VECTOR vec, uint8_t lvl) noexcept
		{
			...
			case ICU::VECTOR::D0FIFO2:
				ICU::IER.D0FIFO2 = 0;
				ICU::IPR.D0FIFO2 = lvl;
				ICU::IER.D0FIFO2 = ena;
				break;
			case ICU::VECTOR::D1FIFO2:
				ICU::IER.D1FIFO2 = 0;
				ICU::IPR.D1FIFO2 = lvl;
				ICU::IER.D1FIFO2 = ena;
				break;
			...
			case ICU::VECTOR::IDEI:
				ICU::IER.IDEI = 0;
				ICU::IPR.IDEI = lvl;
				ICU::IER.IDEI = ena;
				break;
			case ICU::VECTOR::ODFI:
				ICU::IER.ODFI = 0;
				ICU::IPR.ODFI = lvl;
				ICU::IER.ODFI = ena;
				break;
			...
			case ICU::VECTOR::TXI7:
				...
				ICU::IER.TXI7 = ena;
				break;
			case ICU::VECTOR::RXIF8:
				ICU::IER.RXIF8 = 0;
				ICU::IPR.RXIF8 = lvl;
				ICU::IER.RXIF8 = ena;
				break;
			case ICU::VECTOR::TXIF8:
				ICU::IER.TXIF8 = 0;
				ICU::IPR.TXIF8 = lvl;
				ICU::IER.TXIF8 = ena;
				break;
			case ICU::VECTOR::RXIF9:
				ICU::IER.RXIF9 = 0;
				ICU::IPR.RXIF9 = lvl;
				ICU::IER.RXIF9 = ena;
				break;
			case ICU::VECTOR::TXIF9:
				ICU::IER.TXIF9 = 0;
				ICU::IPR.TXIF9 = lvl;
				ICU::IER.TXIF9 = ena;
				break;
			case ICU::VECTOR::RXIF10:
				ICU::IER.RXIF10 = 0;
				ICU::IPR.RXIF10 = lvl;
				ICU::IER.RXIF10 = ena;
				break;
			case ICU::VECTOR::TXIF10:
				ICU::IER.TXIF10 = 0;
				ICU::IPR.TXIF10 = lvl;
				ICU::IER.TXIF10 = ena;
				break;
			...
			case ICU::VECTOR::RXIF11:
				ICU::IER.RXIF11 = 0;
				ICU::IPR.RXIF11 = lvl;
				ICU::IER.RXIF11 = ena;
				break;
			case ICU::VECTOR::TXIF11:
				ICU::IER.TXIF11 = 0;
				ICU::IPR.TXIF11 = lvl;
				ICU::IER.TXIF11 = ena;
				break;
