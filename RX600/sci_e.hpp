...
//=========================================================================//
/*!	@file
	@brief	Serial Communications Interface e / シリアルコミュニケーションインタフェース e
...
namespace device {
	...
	*/
	...
	typedef scie_t<0x0008'A000, peripheral::SCI0, ICU::VECTOR::TXI0, ICU::VECTOR::RXI0,
		ICU::VECTOR::TEI0, ICU::VECTOR::ERI0> SCI0;
	typedef scie_t<0x0008'A020, peripheral::SCI1, ICU::VECTOR::TXI1, ICU::VECTOR::RXI1,
		ICU::VECTOR::TEI1, ICU::VECTOR::ERI1> SCI1;
	typedef scie_t<0x0008'A040, peripheral::SCI2, ICU::VECTOR::TXI2, ICU::VECTOR::RXI2,
	...
	typedef scie_t<0x0008'A100, peripheral::SCI8, ICU::VECTOR::TXI8, ICU::VECTOR::RXI8,
		ICU::VECTOR::TEI8, ICU::VECTOR::ERI8> SCI8;
