...
namespace device {
	...
	//+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++//
	/*!
		@brief  CMPC base class
		@param[in]	base	ベース・アドレス
		@param[in]	cs1_sz	CMPSEL1 サイズ
	*/
	//+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++//
	template <uint32_t base, uint32_t cs1_sz>
	struct cmpc_base_t {
		...
		*/
		...
		struct cmpsel1_t : public rw8_t<ofs> {
			...
			bits_rw_t<io_, bitpos::B0, cs1_sz>  CVRS;
		};
	...
	*/
	...
	struct cmpc_t : public cmpc_base_t<base, 4> {
	...
	*/
	...
	struct cmpca_t : public cmpc_base_t<base, 4> {
	...
	*/
	//+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++//
	template <uint32_t base, peripheral per, typename IVT, IVT ivec>
	struct cmpca2_t : public cmpc_base_t<base, 2> {
		...
		*/
		...
		//-----------------------------------------------------------------//
		/*!
			@brief  ノイズフィルタ設定レジスタ (CMPNFS)
			@param[in]	ofs	オフセット
		*/
		//-----------------------------------------------------------------//
		template <uint32_t ofs>
		struct cmpnfs_t : public rw8_t<ofs> {
			typedef rw8_t<ofs> io_;
			using io_::operator =;
			using io_::operator ();
			using io_::operator |=;
			...
			bits_rw_t<io_, bitpos::B0, 3>  NFSS;
		};
		static inline cmpnfs_t<base + 0x1C> CMPNFS;
	};
	...
	typedef cmpca2_t<0x000A'0C80, peripheral::CMPC0, ICU::VECTOR, ICU::VECTOR::CMPC0> CMPC0;
	typedef cmpca2_t<0x000A'0CA0, peripheral::CMPC1, ICU::VECTOR, ICU::VECTOR::CMPC1> CMPC1;
	typedef cmpca2_t<0x000A'0CC0, peripheral::CMPC2, ICU::VECTOR, ICU::VECTOR::CMPC2> CMPC2;
