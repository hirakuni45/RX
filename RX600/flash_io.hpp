...
#elif defined(SIG_RX65N) || defined(SIG_RX66T) || defined(SIG_RX72T) || defined(SIG_RX72M)
...
#if defined(SIG_RX64M) || defined(SIG_RX71M)
			return false;
#elif defined(SIG_RX24T) || defined(SIG_RX65N) || defined(SIG_RX66T) || defined(SIG_RX72T) || defined(SIG_RX72M) 
			switch(idx) {
			case 0:
				id = FLASH::UIDR0();
				return true;
