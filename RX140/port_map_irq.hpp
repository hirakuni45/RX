...
namespace device {
	...
	*/
	...
	class port_map_irq : public port_map_order {
		...
		{
			switch(odr) {  // IRQ0:
			// IRQ0: P30 (LFQFP64: 14) (LFQFP80: 18)
			// IRQ0: PD0 (LFQFP64: --) (LFQFP80: 66)
			// IRQ0: PH1 (LFQFP64: 23) (LFQFP80: 31)
			case ORDER::FIRST:
				PORT3::PMR.B0 = 0;
				MPC::P30PFS.PSEL = 0;
				MPC::P30PFS.ISEL = ena;
		...
		{
			switch(odr) {  // IRQ1:
			// IRQ1: P31 (LFQFP64: 13) (LFQFP80: 17)
			// IRQ1: PD1 (LFQFP64: --) (LFQFP80: 65)
			// IRQ1: PH2 (LFQFP64: 22) (LFQFP80: 30)
			case ORDER::FIRST:
				PORT3::PMR.B1 = 0;
				MPC::P31PFS.PSEL = 0;
				MPC::P31PFS.ISEL = ena;
		...
		{
			switch(odr) {  // IRQ2:
			// IRQ2: P12 (LFQFP64: --) (LFQFP80: 28)
			// IRQ2: P32 (LFQFP64: 12) (LFQFP80: 16)
			// IRQ2: P36 (LFQFP64:  9) (LFQFP80: 12)
			// IRQ2: PD2 (LFQFP64: --) (LFQFP80: 64)
			case ORDER::FIRST:
				PORT1::PMR.B2 = 0;
				MPC::P12PFS.PSEL = 0;
				MPC::P12PFS.ISEL = ena;
		...
		{
			switch(odr) {  // IRQ4:
			// IRQ4: P14 (LFQFP64: 20) (LFQFP80: 26)
			// IRQ4: P34 (LFQFP64: --) (LFQFP80: 15)
			// IRQ4: P37 (LFQFP64:  7) (LFQFP80: 10)
			// IRQ4: PB1 (LFQFP64: 37) (LFQFP80: 47)
			case ORDER::FIRST:
				PORT1::PMR.B4 = 0;
				MPC::P14PFS.PSEL = 0;
				MPC::P14PFS.ISEL = ena;
		...
		{
			switch(odr) {  // IRQ5:
			// IRQ5: P15 (LFQFP64: 19) (LFQFP80: 25)
			// IRQ5: PA4 (LFQFP64: 42) (LFQFP80: 53)
			// IRQ5: PE5 (LFQFP64: 46) (LFQFP80: 58)
			case ORDER::FIRST:
				PORT1::PMR.B5 = 0;
				MPC::P15PFS.PSEL = 0;
				MPC::P15PFS.ISEL = ena;
		...
		{
			switch(odr) {  // IRQ6:
			// IRQ6: P16 (LFQFP64: 18) (LFQFP80: 24)
			// IRQ6: PA3 (LFQFP64: 43) (LFQFP80: 54)
			case ORDER::FIRST:
				PORT1::PMR.B6 = 0;
				MPC::P16PFS.PSEL = 0;
				MPC::P16PFS.ISEL = ena;
		...
		{
			switch(odr) {  // IRQ7:
			// IRQ7: P17 (LFQFP64: 17) (LFQFP80: 23)
			// IRQ7: PE2 (LFQFP64: 49) (LFQFP80: 61)
			case ORDER::FIRST:
				PORT1::PMR.B7 = 0;
				MPC::P17PFS.PSEL = 0;
				MPC::P17PFS.ISEL = ena;
