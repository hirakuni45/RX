	...
	*/
	...
	class port_map : public port_map_order {
		...
		static bool sci1_(ORDER odr, bool enable, OPTIONAL opt) noexcept
		{
			...
			switch(odr) {
			case ORDER::FIRST:
				// RXD1: P15 (LFQFP64: 19) (LFQFP80: 25)
				// TXD1: P16 (LFQFP64: 18) (LFQFP80: 24)
				// SCK1: P17 (LFQFP64: 17) (LFQFP80: 23)
				PORT1::PMR.B5 = 0;
				PORT1::ODR.B5 = i2c;
			...
			case ORDER::SECOND:  // for BOOT serial port
				// RXD1: P30 (LFQFP64: 14) (LFQFP80: 18)
				// TXD1: P26 (LFQFP64: 16) (LFQFP80: 20)
				// SCK1: P27 (LFQFP64: 15) (LFQFP80: 19)
				PORT3::PMR.B0 = 0;
				PORT3::ODR.B0 = i2c;
		...
		static bool sci5_(ORDER odr, bool enable, OPTIONAL opt) noexcept
		{
			...
			switch(odr) {
			case ORDER::FIRST:
				// RXD5: PA2 (LFQFP64: --) (LFQFP80: 55)
				// TXD5: PA4 (LFQFP64: 42) (LFQFP80: 53)
				// SCK5: PA1 (LFQFP64: 44) (LFQFP80: 56)
				PORTA::PMR.B2 = 0;
				PORTA::ODR.B2 = i2c;
				...
				break;
			case ORDER::SECOND:
				// RXD5: PA3 (LFQFP64: 43) (LFQFP80: 54)
				// TXD5: PA4 (LFQFP64: 42) (LFQFP80: 53)
				// SCK5: PA1 (LFQFP64: 44) (LFQFP80: 56)
				PORTA::PMR.B3 = 0;
				PORTA::ODR.B3 = i2c;
				...
				break;
			case ORDER::THIRD:
				// RXD5: PC2 (LFQFP64: 32) (LFQFP80: 40)
				// TXD5: PC3 (LFQFP64: 31) (LFQFP80: 39)
				// SCK5: PC4 (LFQFP64: 30) (LFQFP80: 38)
				PORTA::PMR.B3 = 0;
				PORTA::ODR.B3 = i2c;
				MPC::PA3PFS.PSEL = sel;  // ok
				PORTA::PMR.B3 = enable;
		...
		static bool sci6_(ORDER odr, bool enable, OPTIONAL opt) noexcept
		{
			...
			switch(odr) {
			case ORDER::FIRST:
				// RXD6: PB0 (LFQFP64: 39) (LFQFP80: 49)
				// TXD6: PB1 (LFQFP64: 37) (LFQFP80: 47)
				// SCK6: PB3 (LFQFP64: 36) (LFQFP80: 45)
				PORTB::PMR.B0 = 0;
				PORTB::ODR.B0 = i2c;
				...
				break;
			case ORDER::SECOND:
				// RXD6: PD1 (LFQFP64: --) (LFQFP80: 65)
				// TXD6: PD0 (LFQFP64: --) (LFQFP80: 66)
				// SCK6: PD2 (LFQFP64: --) (LFQFP80: 64)
				PORTD::PMR.B1 = 0;
				PORTD::ODR.B1 = i2c;
		...
		static bool sci8_(ORDER odr, bool enable, OPTIONAL opt) noexcept
		{
			...
			switch(odr) {
			case ORDER::FIRST:
				// RXD8: PC6 (LFQFP64: 28) (LFQFP80: 36)
				// TXD8: PC7 (LFQFP64: 27) (LFQFP80: 35)
				// SCK8: PC5 (LFQFP64: 29) (LFQFP80: 37)
				PORTC::PMR.B6 = 0;
				PORTC::ODR.B6 = i2c;
		...
		static bool sci9_(ORDER odr, bool enable, OPTIONAL opt) noexcept
		{
			...
			switch(odr) {
			case ORDER::FIRST:
				// RXD9: PB6 (LFQFP64: 34) (LFQFP80: 42)
				// TXD9: PB7 (LFQFP64: 33) (LFQFP80: 41)
				// SCK9: PB5 (LFQFP64: 35) (LFQFP80: 43)
				PORTB::PMR.B6 = 0;
				PORTB::ODR.B6 = i2c;
		...
		static bool sci12_(ORDER odr, bool enable, OPTIONAL opt) noexcept
		{
			...
			switch(odr) {
			case ORDER::FIRST:
				// RXD12: PE2 (LFQFP64: 49) (LFQFP80: 61)
				// TXD12: PE1 (LFQFP64: 50) (LFQFP80: 62)
				// SCK12: PE0 (LFQFP64: 51) (LFQFP80: 63)
				PORTE::PMR.B2 = 0;
				PORTE::ODR.B2 = i2c;
		...
		static bool riic0_(ORDER odr, bool enable) noexcept
		{
			...
			switch(odr) {
			case ORDER::FIRST:
				// SCL0: P16 (LFQFP64: 18) (LFQFP80: 24)
				// SDA0: P17 (LFQFP64: 17) (LFQFP80: 23)
				PORT1::PMR.B6 = 0;
				MPC::P16PFS.PSEL = sel;  // ok
				PORT1::PMR.B6 = enable;
				PORT1::PMR.B7 = 0;
				...
				break;
			case ORDER::SECOND:
				// SCL0: P12 (LFQFP64: --) (LFQFP80: 28)
				// SDA0: P13 (LFQFP64: --) (LFQFP80: 27)
				PORT1::PMR.B2 = 0;
		...
		static bool rspi0_(ORDER odr, bool enable) noexcept
		{
			...
			switch(odr) {
			case ORDER::FIRST:
				// RSPCKA: PA5 (LFQFP64: --) (LFQFP80: 52)
				// MOSIA:  PA6 (LFQFP64: 41) (LFQFP80: 51)
				// MISOA:  PC7 (LFQFP64: 27) (LFQFP80: 35)
				PORTA::PMR.B5 = 0;
				...
				break;
			case ORDER::SECOND:
				// RSPCKA: PB0 (LFQFP64: 39) (LFQFP80: 49)
				// MOSIA:  P16 (LFQFP64: 18) (LFQFP80: 24)
				// MISOA:  P17 (LFQFP64: 17) (LFQFP80: 23)
				PORTB::PMR.B0 = 0;
				MPC::PB0PFS.PSEL = sel;  // ok
				PORTB::PMR.B0 = enable;
				PORT1::PMR.B6 = 0;
				...
				break;
			case ORDER::THIRD:
				// RSPCKA: PC5 (LFQFP64: 29) (LFQFP80: 37)
				// MOSIA:  PC6 (LFQFP64: 28) (LFQFP80: 36)
				// MISOA:  PC7 (LFQFP64: 27) (LFQFP80: 35)
				PORTC::PMR.B5 = 0;
				MPC::PC5PFS.PSEL = sel;  // ok
				PORTC::PMR.B5 = enable;
		...
		static bool rspi0_ssl_(RSPI ssl, ORDER odr, bool enable) noexcept
		{
			...
			switch(ssl) {
			case RSPI::SSL0:
				// SSLA0: PA4 (LFQFP64: 42) (LFQFP80: 53)
				// SSLA0: PC4 (LFQFP64: 30) (LFQFP80: 38)
				if(odr == ORDER::FIRST) {
					PORTA::PMR.B4 = 0;
					MPC::PA4PFS.PSEL = sel;
					PORTA::PMR.B4 = enable;
				...
				break;
			case RSPI::SSL1:
				// SSLA1: PA0 (LFQFP64: 45) (LFQFP80: 57)
				if(odr == ORDER::FIRST) {
					PORTA::PMR.B0 = 0;
					MPC::PA0PFS.PSEL = sel;
					PORTA::PMR.B0 = enable;
				...
				break;
			case RSPI::SSL2:
				// SSLA2: PA1 (LFQFP64: 44) (LFQFP80: 56)
				if(odr == ORDER::FIRST) {
					PORTA::PMR.B1 = 0;
					MPC::PA1PFS.PSEL = sel;
					PORTA::PMR.B1 = enable;
				...
				break;
			case RSPI::SSL3:
				// SSLA3: PA2 (LFQFP64: --) (LFQFP80: 55)
				// SSLA3: PC2 (LFQFP64: 32) (LFQFP80: 40)
				if(odr == ORDER::FIRST) {
					PORTA::PMR.B2 = 0;
					MPC::PA2PFS.PSEL = sel;
					PORTA::PMR.B2 = enable;
		...
		static bool lpt_(ORDER odr, bool enable) noexcept
		{
			switch(odr) {
			case ORDER::FIRST:
				// LPTO:: P26 (LFQFP64: 16) (LFQFP80: 20)
				PORT2::PMR.B6 = 0;
				MPC::P26PFS.PSEL = enable ? 0b1'1011 : 0;  // ok
				PORT2::PMR.B6 = enable;
				break;
			case ORDER::SECOND:
				// LPTO:: PB3 (LFQFP64: 36) (LFQFP80: 45)
				PORTB::PMR.B3 = 0;
				MPC::PB3PFS.PSEL = enable ? 0b1'1011 : 0;  // ok
				PORTB::PMR.B3 = enable;
				break;
			case ORDER::THIRD:
				// LPTO:: PC7 (LFQFP64: 27) (LFQFP80: 35)
				PORTC::PMR.B7 = 0;
		...
		static bool rscan_(ORDER odr, bool enable) noexcept
		{
			...
			switch(odr) {
			case ORDER::FIRST:
				// CRXD0: P15 (LFQFP64: 19) (LFQFP80: 25)
				// CTXD0: P14 (LFQFP64: 20) (LFQFP80: 26)
				PORT1::PMR.B5 = 0;
				MPC::P15PFS.PSEL = sel;  // ok
				PORT1::PMR.B5 = enable;
				PORT1::PMR.B4 = 0;
				...
				break;
			case ORDER::SECOND:
				// CRXD0: P55 (LFQFP64: --) (LFQFP80: 33)
				// CTXD0: P54 (LFQFP64: --) (LFQFP80: 34)
				PORT5::PMR.B5 = 0;
