...
ＲＸマイコンＣ＋＋フレームワークで、もっとも重要な部分でもあります。   
ＲＸマイコンハードウェアーマニュアルで説明されているデバイス名、レジスター名はほぼそのまま使えます。   
   
独自に何かドライバーを作りたい場合や、「iodefine.h」向けに作られた、Ｃのソースを流用する場合に必要な知識です。   
   

- 


まず、「common/renesas.hpp」をインクルードします。   
