...
|R5F566NX----|CodeFlash|RAM|ECCRAM|StanbyRAM|DataFlash|
|---|:-:|:-:|:-:|:-:|:-:|
|R5F566NNxxxx|4M|1M|32K|8K|32K|
|R5F566NDxxxx|2M|1M|32K|8K|32K|
...
- [device.hpp (SIG_RX66N)](../common/device.hpp?ts=4)
- [renesas.hpp (SIG_RX66N)](../common/renesas.hpp?ts=4)

|name space|Device, Renesas|デバイス、ルネサス|
|---|---|---|
|[clock_profile](../RX66N/clock_profile?ts=4)|Clock Profile|クロック・プロファイル|
|[SYSTEM](../RX600/system.hpp?ts=4)|Clock Generation Circuit|クロック発生回路|
|[power_mgr](../RX66N/power_mgr.hpp?ts=4)|Low Power Consumption|消費電力低減機能|
|[ICU](../RX66N/icu.hpp?ts=4)|Interrupt Controller|割り込みコントローラ|
|[icu_mgr](../RX66N/icu_mgr.hpp?ts=4)|ICU Manager|ICU マネージャー|
|[MPC](../RX66N/mpc.hpp?ts=4)|Multi-Function Pin Controller|マルチファンクションピンコントローラ|
|[PORTx](../RX66N/port.hpp?ts=4)|I/O Ports|I/O ポート|
...
|[board_profile](../RX66N/board_profile?ts=4)|Board Profile|ボード・プロファイル|
