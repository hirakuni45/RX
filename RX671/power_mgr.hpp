		...
		*/
		...
		static bool turn(peripheral t, bool ena = true)
		{
			...
			case peripheral::QSPIX:
				SYSTEM::MSTPCRD.MSTPD1 = f;		// QSPIX のストップ状態解除
				break;
			...
			case peripheral::RIICHS0:
				SYSTEM::MSTPCRD.MSTPD5 = f;		// RIICHS0 のストップ状態解除
				break;
			...
			case peripheral::CTSU:
				SYSTEM::MSTPCRD.MSTPD12 = f;	// CTSU のストップ状態解除
				break;
			...
			case peripheral::RSPIA0:
				SYSTEM::MSTPCRD.MSTPD26 = f;	// RSPIA のストップ状態解除
				break;

			case peripheral::TSIP:
				SYSTEM::MSTPCRD.MSTPD27 = f;	// Trusted Secure IP のストップ状態解除
				break;
