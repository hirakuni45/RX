...
- [device.hpp (SIG_RX72N)](../common/device.hpp?ts=4)
- [renesas.hpp (SIG_RX72N)](../common/renesas.hpp?ts=4)

|name space|Device, Renesas|デバイス、ルネサス|
|---|---|---|
|[clock_profile](../RX72N/clock_profile?ts=4)|Clock Profile|クロック・プロファイル|
|[SYSTEM](../RX600/system.hpp?ts=4)|Clock Generation Circuit|クロック発生回路|
|[power_mgr](../RX72N/power_mgr.hpp?ts=4)|Low Power Consumption|消費電力低減機能|
|[ICU](../RX72N/icu.hpp?ts=4)|Interrupt Controller|割り込みコントローラ|
|[icu_mgr](../RX72N/icu_mgr.hpp?ts=4)|ICU Manager|ICU マネージャー|
|[MPC](../RX72N/mpc.hpp?ts=4)|Multi-Function Pin Controller|マルチファンクションピンコントローラ|
|[PORTx](../RX72N/port.hpp?ts=4)|I/O Ports|I/O ポート|
...
|[board_profile](../RX72N/board_profile?ts=4)|Board Profile|ボード・プロファイル|
