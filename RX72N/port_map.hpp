	...
	*/
	...
	class port_map : public port_map_order {
		...
		static bool sci0_(ORDER odr, bool enable, OPTIONAL opt) noexcept
		{
			...
			switch(odr) {
			case ORDER::FIRST:
				// RXD0: P21 (LFQFP176:  44)
				// TXD0: P20 (LFQFP176:  45)
				// SCK0: P22 (LFQFP176:  43)
				PORT2::PMR.B1 = 0;
				PORT2::ODR.B1 = i2c;
				...
				break;
			case ORDER::SECOND:
				// RXD0: P33 (LFQFP176:  28)
				// TXD0: P32 (LFQFP176:  29)
				// SCK0: P34 (LFQFP176:  27)
		...
		static bool sci2_(ORDER odr, bool enable, OPTIONAL opt) noexcept
		{
			...
			switch(odr) {
			case ORDER::FIRST:
				// RXD2: P12 (LFQFP176:  53)
				// TXD2: P13 (LFQFP176:  52)
				// SCK2: P11 (LFQFP176:  67)
				PORT1::PMR.B2 = 0;
				PORT1::ODR.B2 = i2c;
				...
				break;
			case ORDER::SECOND:
				// RXD2: P52 (LFQFP176:  70)
				// TXD2: P50 (LFQFP176:  72)
				// SCK2: P51 (LFQFP176:  71)
				PORT5::PMR.B2 = 0;
				PORT5::ODR.B2 = i2c;
		...
		static bool sci3_(ORDER odr, bool enable, OPTIONAL opt) noexcept
		{
			...
			switch(odr) {
			case ORDER::FIRST:
				// RXD3: P16 (LFQFP176:  48)
				// TXD3: P17 (LFQFP176:  46)
				// SCK3: P15 (LFQFP176:  50)
				PORT1::PMR.B6 = 0;
				PORT1::ODR.B6 = i2c;
				MPC::P16PFS.PSEL = sel;  // ok
				PORT1::PMR.B6 = enable;
				...
				break;
			case ORDER::SECOND:
				// RXD3: P25 (LFQFP176:  38)
				// TXD3: P23 (LFQFP176:  42)
				// SCK3: P24 (LFQFP176:  40)
		...
		static bool sci4_(ORDER odr, bool enable, OPTIONAL opt) noexcept
		{
			...
			case ORDER::FIRST:
				// 100 pin 未対応
				// RXD4: PB0 (LFQFP176: 104)
				// TXD4: PB1 (LFQFP176: 100)
				// SCK4: PB3 (LFQFP176:  98)
				PORTB::PMR.B0 = 0;
				PORTB::ODR.B0 = i2c;
		...
		static bool sci6_(ORDER odr, bool enable, OPTIONAL opt) noexcept
		{
			...
			case ORDER::SECOND:
				...
				break;
			case ORDER::THIRD:
				// RXD6: PB0 (LFQFP176: 100)
				// TXD6: PB1 (LFQFP176: 104)
		...
		static bool sci8_(ORDER odr, bool enable, OPTIONAL opt) noexcept
		{
			...
			switch(odr) {
			case ORDER::FIRST:
				// RXD8: PC6 (LFQFP176:  77)
				// TXD8: PC7 (LFQFP176:  76)
				// SCK8: PC5 (LFQFP176:  78)
				PORTC::PMR.B6 = 0;
				PORTC::ODR.B6 = i2c;
		...
		static bool sci9_(ORDER odr, bool enable, OPTIONAL opt) noexcept
		{
			...
			switch(odr) {
			case ORDER::FIRST:
				// RXD9: PB6 (LFQFP176: 95)
				// TXD9: PB7 (LFQFP176: 94)
				// SCK9: PB5 (LFQFP176: 96)
				PORTB::PMR.B6 = 0;
				PORTB::ODR.B6 = i2c;
		...
		static bool sci11_(ORDER odr, bool enable, OPTIONAL opt) noexcept
		{
			...
			switch(odr) {
			case ORDER::FIRST:
				// RXD11: P76 (LFQFP176: 85)
				// TXD11: P77 (LFQFP176: 84)
				// SCK11: P75 (LFQFP176: 87)
				PORT7::PMR.B6 = 0;
				PORT7::ODR.B6 = i2c;
		...
		static bool sci12_(ORDER odr, bool enable, OPTIONAL opt) noexcept
		{
			...
			switch(odr) {
			case ORDER::FIRST:
				// RXD12: PE2 (LFQFP176: 133)
				// TXD12: PE1 (LFQFP176: 134)
				// SCK12: PE0 (LFQFP176: 135)
				PORTE::PMR.B2 = 0;
				PORTE::ODR.B2 = i2c;
		...
		static bool riic0_(ORDER odr, bool enable) noexcept
		{
			...
			switch(odr) {
			case ORDER::FIRST:
				// SCL0: P12 (LFQFP176:  53)
				// SDA0: P13 (LFQFP176:  52)
				PORT1::PMR.B2 = 0;
				MPC::P12PFS.PSEL = sel;  // ok
				PORT1::PMR.B2 = enable;
				PORT1::PMR.B3 = 0;
		...
		static bool can1_(ORDER odr, bool enable) noexcept
		{
			...
			case ORDER::SECOND:
				...
				break;
			case ORDER::THIRD:
				// CRX1: P15 (LFQFP176:  50)
				// CTX1: P23 (LFQFP176:  42)
				PORT1::PMR.B5 = 0;
				MPC::P15PFS.PSEL = sel;  // ok
				PORT1::PMR.B5 = enable;
				PORT2::PMR.B3 = 0;
		...
		static bool can2_(ORDER odr, bool enable) noexcept
		{
			...
			switch(odr) {
			case ORDER::FIRST:
				// CRX2: P67 (LFQFP176: 120)
				// CTX2: P66 (LFQFP176: 122)
				PORT6::PMR.B7 = 0;
