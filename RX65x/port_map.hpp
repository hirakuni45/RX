	...
	*/
	...
	class port_map : public port_map_order {
		...
		static bool sci0_(ORDER odr, bool enable, OPTIONAL opt) noexcept
		{
			...
			switch(odr) {
			case ORDER::FIRST:
			// RXD0: P21 RXD0/SMOSI0/SSDA0 (LFQFP176:  44)
			// TXD0: P20 TXD0/SMISO0/SSCL0 (LFQFP176:  45)
			// SCK0: P22 SCK0 (LFQFP176:  43)
				PORT2::PMR.B1 = 0;
				PORT2::PDR.B1 = i2c;
				...
				break;
			case ORDER::SECOND:
			// RXD0: P33 RXD0/SMISO0/SSCL0 (LFQFP176:  28)
			// TXD0: P32 TXD0/SMOSI0/SSDA0 (LFQFP176:  29)
			// SCK0: P34 SCK0 (LFQFP176:  27)
		...
		static bool sci1_(ORDER odr, bool enable, OPTIONAL opt) noexcept
		{
			...
			// SCK1: P27 (LFQFP176:  36)
				...
				break;
			case ORDER::THIRD:
			// RXD1: PF2 RXD1/SMOSI1/SSDA1 (LFQFP176:  31)
			// TXD1: PF0 TXD1/SMISO1/SSCL1 (LFQFP176:  35)
			// SCK1: PF1 SCK1 (LFQFP176:  34)
				PORTF::PMR.B2 = 0;
				PORTF::ODR.B2 = i2c;
		...
		static bool sci2_(ORDER odr, bool enable, OPTIONAL opt) noexcept
		{
			...
			switch(odr) {
			case ORDER::FIRST:
			// RXD2: P12 RXD2/SMOSI2/SSDA2 (LFQFP176:  53)
			// TXD2: P13 TXD2/SMISO2/SSCL2 (LFQFP176:  52)
			// SCK2: P11 SCK2 (LFQFP176:  67)
				PORT1::PMR.B2 = 0;
				PORT1::ODR.B2 = i2c;
				...
				break;
			case ORDER::SECOND:
			// RXD2: P52 RXD2/SMISO2/SSCL2 (LFQFP176:  70)
			// TXD2: P50 TXD2/SMOSI2/SSDA2 (LFQFP176:  72)
			// SCK2: P51 SCK2 (LFQFP176:  71)
				PORT5::PMR.B2 = 0;
				PORT5::ODR.B2 = i2c;
		...
		static bool sci3_(ORDER odr, bool enable, OPTIONAL opt) noexcept
		{
			...
			switch(odr) {
			case ORDER::FIRST:
			// RXD3: P16 RXD3/SMISO3/SSCL3 (LFQFP176:  48)
			// TXD3: P17 TXD3/SMOSI3/SSDA3 (LFQFP176:  46)
			// SCK3: P15 SCK3 (LFQFP176:  50)
				PORT1::PMR.B6 = 0;
				PORT1::ODR.B6 = i2c;
				MPC::P16PFS.PSEL = sel;  // ok
				PORT1::PMR.B6 = enable;
				...
				break;
			case ORDER::SECOND:
			// RXD3: P25 RXD3/SMOSI3/SSDA3 (LFQFP176:  38)
			// TXD3: P23 TXD3/SMISO3/SSCL3 (LFQFP176:  42)
			// SCK3: P24 SCK3 (LFQFP176:  40)
		...
		static bool sci4_(ORDER odr, bool enable, OPTIONAL opt) noexcept
		{
			...
			switch(odr) {
			case ORDER::FIRST:
			// RXD4: PB0 RXD4/SMOSI4/SSDA4 (LFQFP176: 104)
			// TXD4: PB1 TXD4/SMISO4/SSCL4 (LFQFP176: 100)
			// SCK4: PB3 SCK4 (LFQFP176:  98)
				PORTB::PMR.B0 = 0;
				PORTB::ODR.B0 = i2c;
		...
		static bool sci6_(ORDER odr, bool enable, OPTIONAL opt) noexcept
		{
			...
			switch(odr) {
			case ORDER::FIRST:
			// RXD6: P01 RXD6/SMOSI6/SSDA6 (LFQFP176:   7)
			// TXD6: P00 TXD6/SMISO6/SSCL6 (LFQFP176:   8)
			// SCK6: P02 SCK6 (LFQFP176:   6)
				PORT0::PMR.B1 = 0;
				PORT0::ODR.B1 = i2c;
				...
				break;
			case ORDER::SECOND:
			// RXD6: P33 (LFQFP176:  28)
			// TXD6: P32 (LFQFP176:  29)
			// SCK6: P34 (LFQFP176:  27)
				PORT3::PMR.B3 = 0;
				PORT3::ODR.B3 = i2c;
				MPC::P33PFS.PSEL = sel;  // ok
				PORT3::PMR.B3 = enable;
				...
				break;
			case ORDER::THIRD:
			// RXD6: PB0 TXD6/SMOSI6/SSDA6 (LFQFP176: 100)
			// TXD6: PB1 RXD6/SMISO6/SSCL6 (LFQFP176: 104)
			// SCK6: PB3 SCK6 (LFQFP176:  98)
		...
		static bool sci7_(ORDER odr, bool enable, OPTIONAL opt) noexcept
		{
			...
			switch(odr) {
			case ORDER::FIRST:
			// RXD7: P57 (LFQFP176: 160)
			// TXD7: P55 (LFQFP176: 163)
			// SCK7: P56 (LFQFP176: 161)
				PORT5::PMR.B7 = 0;
				PORT5::ODR.B7 = i2c;
				...
				break;
			case ORDER::SECOND:
			// RXD7: P92 RXD7/SMOSI7/SSDA7 (LFQFP176: 160)
			// TXD7: P90 TXD7/SMISO7/SSCL7 (LFQFP176: 163)
			// SCK7: P91 SCK7 (LFQFP176: 161)
				PORT9::PMR.B2 = 0;
				PORT9::ODR.B2 = i2c;
		...
		static bool sci8_(ORDER odr, bool enable, OPTIONAL opt) noexcept
		{
			...
			switch(odr) {
			case ORDER::FIRST:
			// RXD8: PC6 RXD8/SMOSI8/SSDA8 (LFQFP176:  77)
			// TXD8: PC7 TXD8/SMISO8/SSCL8 (LFQFP176:  76)
			// SCK8: PC5 SCK8 (LFQFP176:  78)
				PORTC::PMR.B6 = 0;
				PORTC::ODR.B6 = i2c;
				...
				break;
			case ORDER::SECOND:
			// RXD8: PJ1 (LFQFP176:  59)
			// TXD8: PJ2 (LFQFP176:  58)
			// SCK8: PJ0 (LFQFP176:  60)
				PORTJ::PMR.B1 = 0;
				PORTJ::ODR.B1 = i2c;
		...
		static bool sci9_(ORDER odr, bool enable, OPTIONAL opt) noexcept
		{
			...
			// RXD9: PB6 RXD9/SMOSI9/SSDA9 (LFQFP176: 95)
			// TXD9: PB7 TXD9/SMISO9/SSCL9 (LFQFP176: 94)
			// SCK9: PB5 SCK9 (LFQFP176: 96)
				PORTB::PMR.B6 = 0;
				PORTB::ODR.B6 = i2c;
		...
		static bool sci10_(ORDER odr, bool enable, OPTIONAL opt) noexcept
		{
			...
			switch(odr) {
			case ORDER::FIRST:
			// RXD10: P81 (LFQFP176:  80)
			// TXD10: P82 (LFQFP176:  79)
			// SCK10: P80 (LFQFP176:  81)
				PORTB::PMR.B1 = 0;
				PORTB::ODR.B1 = i2c;
				MPC::PB1PFS.PSEL = sel;  // ok
				PORTB::PMR.B1 = enable;
				...
				break;
			case ORDER::SECOND:
			// RXD10: P86 (LFQFP176:  49)
			// TXD10: P87 (LFQFP176:  47)
			// SCK10: P83 (LFQFP176:  74)
				PORT8::PMR.B6 = 0;
				PORT8::ODR.B6 = i2c;
				...
				break;
			case ORDER::THIRD:
			// RXD10: PC6 (LFQFP176:  77)
			// TXD10: PC7 (LFQFP176:  76)
			// SCK10: PC5 (LFQFP176:  78)
		...
		static bool sci11_(ORDER odr, bool enable, OPTIONAL opt) noexcept
		{
			...
			switch(odr) {
			case ORDER::FIRST:
			// RXD11: P76 RXD11/SMOSI11/SSDA11 (LFQFP176: 85)
			// TXD11: P77 TXD11/SMISO11/SSCL11 (LFQFP176: 84)
			// SCK11: P75 SCK11 (LFQFP176: 87)
				PORT7::PMR.B6 = 0;
				PORT7::ODR.B6 = i2c;
				...
				break;
			case ORDER::SECOND:
			// RXD11: PB6 (LFQFP176:  95)
			// TXD11: PB7 (LFQFP176:  94)
			// SCK11: PB5 (LFQFP176:  96)
		...
		static bool sci12_(ORDER odr, bool enable, OPTIONAL opt) noexcept
		{
			...
			switch(odr) {
			case ORDER::FIRST:
			// RXD12: PE2 RXD12/SMISO12/SSCL12 (LFQFP176: 133)
			// TXD12: PE1 TXD12/SMOSI12/SSDA12 (LFQFP176: 134)
			// SCK12: PE0 SCK12 (LFQFP176: 135)
				PORTE::PMR.B2 = 0;
				PORTE::ODR.B2 = i2c;
		...
		static bool riic2_(ORDER odr, bool enable) noexcept
		{
			...
			switch(odr) {
			case ORDER::FIRST:
			// SCL2: P16 (LFQFP176: 48)
			// SDA2: P17 (LFQFP176: 46)
				PORT1::PMR.B6 = 0;
				MPC::P16PFS.PSEL = sel;  // ok
				PORT1::PMR.B6 = enable;
				PORT1::PMR.B7 = 0;
		...
		static bool can0_(ORDER odr, bool enable) noexcept
		{
			...
			switch(odr) {
			case ORDER::FIRST:
			// CRX0: P33 (LFQFP176:  28)
			// CTX0: P32 (LFQFP176:  29)
				PORT3::PMR.B3 = 0;
				MPC::P33PFS.PSEL = sel;  // ok
				PORT3::PMR.B3 = enable;
				PORT3::PMR.B2 = 0;
				...
				break;
			case ORDER::SECOND:
			// CRX0: PD2 (LFQFP176: 154)
			// CTX0: PD1 (LFQFP176: 156)
				PORTD::PMR.B2 = 0;
		...
		static bool can1_(ORDER odr, bool enable) noexcept
		{
			...
			switch(odr) {
			case ORDER::FIRST:
			// CRX1-DS:  P15 (LFQFP176:  50)
			// CTX1:     P14 (LFQFP176:  51)
				PORT1::PMR.B5 = 0;
				MPC::P15PFS.PSEL = sel;  // ok
				PORT1::PMR.B5 = enable;
				PORT1::PMR.B4 = 0;
				...
				break;
			case ORDER::SECOND:
			// CRX1: P55 (LFQFP176:  65)
			// CTX1: P54 (LFQFP176:  66)
				PORT5::PMR.B5 = 0;
				MPC::P55PFS.PSEL = sel;  // ok
				PORT5::PMR.B5 = enable;
				PORT5::PMR.B4 = 0;
		...
		static bool rspi0_(ORDER odr, bool enable) noexcept
		{
			...
			switch(odr) {
			case ORDER::FIRST:
			// RSPCKA: PA5 RSPCKA-B (LFQFP176: 108)
			// MOSIA:  PA6 MOSIA-B  (LFQFP176: 107)
			// MISOA:  PA7 MISOA-B  (LFQFP176: 106)
				PORTA::PMR.B5 = 0;
				...
				break;
			case ORDER::SECOND:
			// RSPCKA: PC5 RSPCKA-A (LFQFP176:  78)
			// MOSIA:  PC6 MOSIA-A  (LFQFP176:  77)
			// MISOA:  PC7 MISOA-A  (LFQFP176:  76)
				PORTC::PMR.B5 = 0;
				MPC::PC5PFS.PSEL = sel;  // ok
				PORTC::PMR.B5 = enable;
				PORTC::PMR.B6 = 0;
		...
		static bool rspi0_ssl_(RSPI ssl, ORDER odr, bool enable) noexcept
		{
			...
			switch(ssl) {
			case RSPI::SSL0:
				// SSLA0: PA4 (LFQFP176: 109)
				// SSLA0: PC4 (LFQFP176:  82)
				if(odr == ORDER::FIRST) {
					PORTA::PMR.B4 = 0;
					MPC::PA4PFS.PSEL = sel;
					PORTA::PMR.B4 = enable;
				...
				break;
			case RSPI::SSL1:
				// SSLA1: PA0 (LFQFP176: 118)
				// SSLA1: PC0 (LFQFP176:  91)
				if(odr == ORDER::FIRST) {
					PORTA::PMR.B0 = 0;
					MPC::PA0PFS.PSEL = sel;
					PORTA::PMR.B0 = enable;
				...
				break;
			case RSPI::SSL2:
				// SSLA2: PA1 (LFQFP176: 114)
				// SSLA2: PC1 (LFQFP176:  89)
				if(odr == ORDER::FIRST) {
					PORTA::PMR.B1 = 0;
					MPC::PA1PFS.PSEL = sel;
					PORTA::PMR.B1 = enable;
				...
				break;
			case RSPI::SSL3:
				// SSLA3: PA2 (LFQFP176: 112)
				// SSLA3: PC2 (LFQFP176:  86)
				if(odr == ORDER::FIRST) {
					PORTA::PMR.B2 = 0;
					MPC::PA2PFS.PSEL = sel;
					PORTA::PMR.B2 = enable;
		...
		static bool rspi1_(ORDER odr, bool enable) noexcept
		{
			...
			switch(odr) {
			case ORDER::FIRST:
			// RSPCKB: P27 (LFQFP176:  36)
			// MOSIB:  P26 (LFQFP176:  37)
			// MISOB:  P30 (LFQFP176:  33)
				PORT2::PMR.B7 = 0;
				MPC::P27PFS.PSEL = sel;  // ok
				PORT2::PMR.B7 = enable;
				PORT2::PMR.B6 = 0;
				...
				break;
			case ORDER::SECOND:
			// RSPCKB: PE5 (LFQFP176: 130)
			// MOSIB:  PE6 (LFQFP176: 126)
			// MISOB:  PE7 (LFQFP176: 125)
				PORTE::PMR.B5 = 0;
		...
		static bool rspi1_ssl_(RSPI ssl, ORDER odr, bool enable) noexcept
		{
			...
			switch(ssl) {
			case RSPI::SSL0:
				// SSLB0: P31 (LFQFP176:  32)
				// SSLB0: PE4 (LFQFP176: 131)
				if(odr == ORDER::FIRST) {
					PORT3::PMR.B1 = 0;
					MPC::P31PFS.PSEL = sel;
					PORT3::PMR.B1 = enable;
				...
				break;
			case RSPI::SSL1:
				// SSLB1: P50 (LFQFP176:  72)
				// SSLB1: PE0 (LFQFP176: 135)
				if(odr == ORDER::FIRST) {
					PORT5::PMR.B0 = 0;
					MPC::P50PFS.PSEL = sel;
					PORT5::PMR.B0 = enable;
				...
				break;
			case RSPI::SSL2:
				// SSLB2: P51 (LFQFP176:  71)
				// SSLB2: PE1 (LFQFP176: 134)
				if(odr == ORDER::FIRST) {
					PORT5::PMR.B1 = 0;
					MPC::P51PFS.PSEL = sel;
					PORT5::PMR.B1 = enable;
				...
				break;
			case RSPI::SSL3:
				// SSLB3: P52 (LFQFP176:  70)
				// SSLB3: PE2 (LFQFP176: 133)
				if(odr == ORDER::FIRST) {
					PORT5::PMR.B2 = 0;
					MPC::P52PFS.PSEL = sel;
					PORT5::PMR.B2 = enable;
		...
		static bool rspi2_(ORDER odr, bool enable) noexcept
		{
			...
			switch(odr) {
			case ORDER::FIRST:
			// RSPCKC: P56 (LFQFP176:  64)
			// MOSIC:  P54 (LFQFP176:  66)
			// MISOC:  P55 (LFQFP176:  65)
				PORT5::PMR.B6 = 0;
				MPC::P56PFS.PSEL = sel;  // ok
				PORT5::PMR.B6 = enable;
				PORT5::PMR.B4 = 0;
				...
				break;
			case ORDER::SECOND:
			// RSPCKC: PD3 (LFQFP176: 150)
			// MOSIC:  PD1 (LFQFP176: 156)
			// MISOC:  PD2 (LFQFP176: 154)
				PORTD::PMR.B3 = 0;
		...
		static bool rspi2_ssl_(RSPI ssl, ORDER odr, bool enable) noexcept
		{
			...
			switch(ssl) {
			case RSPI::SSL0:
				// SSLC0: P57 (LFQFP176:  63)
				// SSLC0: PD4 (LFQFP176: 148)
				if(odr == ORDER::FIRST) {
					PORT5::PMR.B7 = 0;
					MPC::P57PFS.PSEL = sel;
					PORT5::PMR.B7 = enable;
				...
				break;
			case RSPI::SSL1:
				// SSLC1: PD5 (LFQFP176: 147)
				// SSLC1: PJ0 (LFQFP176:  60)
				if(odr == ORDER::FIRST) {
					PORTD::PMR.B5 = 0;
					MPC::PD5PFS.PSEL = sel;
					PORTD::PMR.B5 = enable;
				...
				break;
			case RSPI::SSL2:
				// SSLC2: PD6 (LFQFP176: 145)
				// SSLC2: PJ1 (LFQFP176:  59)
				if(odr == ORDER::FIRST) {
					PORTD::PMR.B6 = 0;
					MPC::PD6PFS.PSEL = sel;
					PORTD::PMR.B6 = enable;
				...
				break;
			case RSPI::SSL3:
				// SSLC3: PD7 (LFQFP176: 143)
				// SSLC3: PJ2 (LFQFP176:  58)
				if(odr == ORDER::FIRST) {
					PORTD::PMR.B7 = 0;
					MPC::PD7PFS.PSEL = sel;
					PORTD::PMR.B7 = enable;
