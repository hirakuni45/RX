...
- [device.hpp (SIG_RX651, SIG_RX65N)](../common/device.hpp?ts=4)
- [renesas.hpp (SIG_RX651, SIG_RX65N)](../common/renesas.hpp?ts=4)

|name space|Device, Renesas|デバイス、ルネサス|
|---|---|---|
|[clock_profile](../RX65x/clock_profile?ts=4)|Clock Profile|クロック・プロファイル|
|[SYSTEM](../RX600/system.hpp?ts=4)|Clock Generation Circuit|クロック発生回路|
|[power_mgr](../RX65x/power_mgr.hpp?ts=4)|Low Power Consumption|消費電力低減機能|
|[ICU](../RX65x/icu.hpp?ts=4)|Interrupt Controller|割り込みコントローラ|
|[icu_mgr](../RX65x/icu_mgr.hpp?ts=4)|ICU Manager|ICU マネージャー|
|[MPC](../RX65x/mpc.hpp?ts=4)|Multi-Function Pin Controller|マルチファンクションピンコントローラ|
|[PORTx](../RX65x/port.hpp?ts=4)|I/O Ports|I/O ポート|
|[port_map](../RX65x/port_map.hpp?ts=4)|Port Mapping|ポート・マッピング|
...
|[board_profile](../RX65x/board_profile?ts=4)|Board Profile|ボード・プロファイル|
...
|[POE3](../RX65x/poe3.hpp?ts=4)|Port Output Enable 3|ポートアウトプットイネーブル３|
