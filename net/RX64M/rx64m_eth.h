...
#ifndef RX64M_ETH_TX_BUFFER_COUNT
   #define RX64M_ETH_TX_BUFFER_COUNT 3
#elif (RX64M_ETH_TX_BUFFER_COUNT < 1)
   #error RX64M_ETH_TX_BUFFER_COUNT parameter is not valid
#endif

//TX buffer size
#ifndef RX64M_ETH_TX_BUFFER_SIZE
   #define RX64M_ETH_TX_BUFFER_SIZE 1536
#elif (RX64M_ETH_TX_BUFFER_SIZE != 1536)
   #error RX64M_ETH_TX_BUFFER_SIZE parameter is not valid
#endif

//Number of RX buffers
#ifndef RX64M_ETH_RX_BUFFER_COUNT
   #define RX64M_ETH_RX_BUFFER_COUNT 6
#elif (RX64M_ETH_RX_BUFFER_COUNT < 1)
   #error RX64M_ETH_RX_BUFFER_COUNT parameter is not valid
#endif

//RX buffer size
#ifndef RX64M_ETH_RX_BUFFER_SIZE
   #define RX64M_ETH_RX_BUFFER_SIZE 1536
#elif (RX64M_ETH_RX_BUFFER_SIZE != 1536)
   #error RX64M_ETH_RX_BUFFER_SIZE parameter is not valid
#endif

//Ethernet interrupt priority
#ifndef RX64M_ETH_IRQ_PRIORITY
   #define RX64M_ETH_IRQ_PRIORITY 2
#elif (RX64M_ETH_IRQ_PRIORITY < 0)
   #error RX64M_ETH_IRQ_PRIORITY parameter is not valid
#endif
...
//RX64M Ethernet MAC driver
extern const NicDriver rx64mEthDriver;

#ifdef __cplusplus
extern "C" {
#endif

//RX64M Ethernet MAC related functions
