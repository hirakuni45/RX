...
#define __T4_VERSION__ "2.06"

#if defined(__GNUC__)
#if (defined(__RX__) && (__BYTE_ORDER__ == __ORDER_LITTLE_ENDIAN__))
#define __TARGET_CPU__ "KPIT GNURX RX600 LITTLE endian"
...
#define __TARGET_CPU__ "SC32 BIG endian"
#define __COMPILER_VER__ (((uint32_t)__GNUC__) << 16 | (((uint32_t)__GNUC_MINOR__) << 8) | (uint32_t)__GNUC_PATCHLEVEL__)
#elif (defined(__GNUC__) && (__BYTE_ORDER__ == __ORDER_LITTLE_ENDIAN__))
#define __TARGET_CPU__ "SC32 LITTLE endian"
#define __COMPILER_VER__ (((uint32_t)__GNUC__) << 16 | (((uint32_t)__GNUC_MINOR__) << 8) | (uint32_t)__GNUC_PATCHLEVEL__)
#endif
