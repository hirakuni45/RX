...
//=====================================================================//
/*!	@file
	@brief	RX64M グループ MPC 定義
    @author 平松邦仁 (hira@rvf-rc45.net)
	@copyright	Copyright (C) 2013, 2015 Kunihito Hiramatsu @n
	...
	*/
	...
	struct mpc_t {
		...
		*/
		...
		static pfsy_t<0x0008C1BB> PF3PFS;
		static pfsy_t<0x0008C1BC> PF4PFS;
		static pfsy_t<0x0008C1BD> PF5PFS;
