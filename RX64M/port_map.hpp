	...
	class port_map : public port_map_order {
		...
		static bool sci6_(ORDER odr, bool enable, OPTIONAL opt) noexcept
		{
			...
			// SCK6: P34 (LFQFP176:  27)
				...
				break;
			case ORDER::THIRD:
			// RXD6: PB0 (LFQFP176: 104)
			// TXD6: PB1 (LFQFP176: 100)
			// SCK6: PB3 (LFQFP176:  98)
		...
		static bool sci7_(ORDER odr, bool enable, OPTIONAL opt) noexcept
		{
			...
			// RXD7: P92 (LFQFP176: 160)
			// TXD7: P90 (LFQFP176: 163)
			// SCK7: P91 (LFQFP176: 161)
				PORT9::PMR.B2 = 0;
				PORT9::ODR.B2 = i2c;
		...
		static bool scif8_(ORDER odr, bool enable, OPTIONAL opt) noexcept
		{
			...
			switch(odr) {
			case ORDER::FIRST:
			// RXD8: PC6 RXD(F)8/SMOSI8/SSDA8 (LFQFP176:  77)
			// TXD8: PC7 TXD(F)8/SMISO8/SSCL8 (LFQFP176:  76)
		...
		static bool scif9_(ORDER odr, bool enable, OPTIONAL opt) noexcept
		{
			...
			switch(odr) {
			case ORDER::FIRST:
			// RXD9: PB6 RXD(F)9/SMOSI9/SSDA9 (LFQFP176:  95)
			// TXD9: PB7 TXD(F)9/SMISO9/SSCL9 (LFQFP176:  94)
		...
		static bool scif11_(ORDER odr, bool enable, OPTIONAL opt) noexcept
		{
			...
			switch(odr) {
			case ORDER::FIRST:
			// RXD11: P76 RXD(F)11/SMOSI11/SSDA11 (LFQFP176:  85)
			// TXD11: P77 TXD(F)11/SMISO11/SSCL11 (LFQFP176:  84)
		...
		static bool riic0_(ORDER odr, bool enable) noexcept
		{
			...
			switch(odr) {
			case ORDER::FIRST:
			// SCL0: P12 SCL0 (LFQFP176:  53)
			// SDA0: P13 SDA0 (LFQFP176:  52)
				PORT1::PMR.B2 = 0;
				MPC::P12PFS.PSEL = sel;  // ok
				PORT1::PMR.B2 = enable;
				PORT1::PMR.B3 = 0;
		...
		static bool riic2_(ORDER odr, bool enable) noexcept
		{
			...
			switch(odr) {
			case ORDER::FIRST:
			// SCL2: P16 SCL2 (LFQFP176:  48)
			// SDA2: P17 SDA2 (LFQFP176:  46)
				PORT1::PMR.B6 = 0;
				MPC::P16PFS.PSEL = sel;  // ok
				PORT1::PMR.B6 = enable;
				PORT1::PMR.B7 = 0;
		...
		static bool can0_(ORDER odr, bool enable) noexcept
		{
			...
			switch(odr) {
			case ORDER::FIRST:
			// CRX0: P33 CRX0 (LFQFP176:  28)
			// CTX0: P32 CTX0 (LFQFP176:  29)
				PORT3::PMR.B3 = 0;
				MPC::P33PFS.PSEL = sel;  // ok
				PORT3::PMR.B3 = enable;
				PORT3::PMR.B2 = 0;
				...
				break;
			case ORDER::SECOND:
			// CRX0: PD2 CRX0 (LFQFP176: 154)
			// CTX0: PD1 CTX0 (LFQFP176: 156)
				PORTD::PMR.B2 = 0;
		...
		static bool can1_(ORDER odr, bool enable) noexcept
		{
			...
			switch(odr) {
			case ORDER::FIRST:
			// CRX1: P15 CRX1-DS (LFQFP176:  50)
			// CTX1: P14 CTX1    (LFQFP176:  51)
				PORT1::PMR.B5 = 0;
				MPC::P15PFS.PSEL = sel;  // ok
				PORT1::PMR.B5 = enable;
				PORT1::PMR.B4 = 0;
				...
				break;
			case ORDER::SECOND:
			// CRX1: P55 CRX1 (LFQFP176:  65)
			// CTX1: P54 CTX1 (LFQFP176:  66)
				PORT5::PMR.B5 = 0;
		...
		static bool can2_(ORDER odr, bool enable) noexcept
		{
			...
			switch(odr) {
			case ORDER::FIRST:
			// CRX2: P67 CRX2 (LFQFP176: 120)
			// CTX2: P66 CTX2 (LFQFP176: 122)
				PORT6::PMR.B7 = 0;
