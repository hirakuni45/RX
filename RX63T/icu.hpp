...
namespace device {
	...
	*/
	...
	struct icu_t : public ICU_BASE {
		...
		*/
		//+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++//
		static VECTOR get_group_vector(VECTOR_GROUP0 ivec) noexcept {
			return VECTOR::GROUP0;
		}
		...
		*/
		//+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++//
		static VECTOR get_group_vector(VECTOR_GROUP12 ivec) noexcept {
			return VECTOR::GROUP12;
		}
