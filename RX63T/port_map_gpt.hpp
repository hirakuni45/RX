	...
	*/
	...
	class port_map_gpt : public port_map_order {
		...
		static bool gpt3_(CHANNEL ch, bool ena, ORDER odr) noexcept
		{
			...
			// P01 (LFQFP64:  4) (LFQFP100:   4)
			// PD0 (LFQFP64: --) (LFQFP100:  25)
				switch(odr) {
				case ORDER::FIRST:
					PORT0::PMR.B1 = 0;
