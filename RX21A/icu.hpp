...
//=========================================================================//
/*!	@file
	@brief	Interrupt Controller / 割り込みコントローラ (RX21A)
	...
	struct icu_t : public ICU_BASE, ICU_IRQ8 {
		...
		*/
		...
		enum class VECTOR {
			...
			ICEEI1  = 246,  ///< RIIC1 (EEI1)
			ICRXI1  = 247,  ///< RIIC1 (RXI1)
			ICTXI1  = 248,  ///< RIIC1 (TXI1)
			ICTEI1  = 249,  ///< RIIC1 (TEI1)
		};
		...
		struct ipr_t {
			...
			*/
			...
			volatile uint8_t& operator [] (VECTOR vec) {
				...
				case VECTOR::SPTI1:
				case VECTOR::SPII1:
					idx = static_cast<uint32_t>(VECTOR::SPEI1);
					break;
