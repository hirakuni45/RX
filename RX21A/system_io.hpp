...
*/
//=========================================================================//
#include "RX21A/system.hpp"
#include "RX21A/clock_profile.hpp"
	...
	public:
		...
		*/
		...
		static bool boost_master_clock()
		{
			...
			// クロック関係書き込み許可
			SYSTEM::PRCR = SYSTEM::PRCR.PRKEY.b(0xA5) | SYSTEM::PRCR.PRC0.b(1) | SYSTEM::PRCR.PRC1.b(1);
			...
			SYSTEM::SCKCR = SYSTEM::SCKCR.ICK.b(clock_div_(clock_profile::ICLK))
						  ...
						  | SYSTEM::SCKCR.PCKC.b(clock_div_(clock_profile::PCLKC))
