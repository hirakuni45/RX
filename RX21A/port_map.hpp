...
namespace device {
	...
	//+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++//
	/*!
		@brief  RX21A ポート・マッピング・ユーティリティー
	*/
	//+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++//
	class port_map : public port_map_order {
		...
		static bool sci8_(ORDER odr, bool enable, OPTIONAL opt) noexcept
		{
			...
			switch(odr) {
			case ORDER::FIRST:
				// RXD8: PC6 (LFQFP64: ) (LFQFP100:  )
				// TXD8: PC7 (LFQFP64: ) (LFQFP100:  )
				// SCK8: PC5 (LFQFP64: ) (LFQFP100:  )
				sel = enable ? 0b1010 : 0;
				PORTC::PMR.B6 = 0;
				PORTC::ODR.B6 = i2c;
		...
		static bool riic1_(ORDER odr, bool enable) noexcept
		{
			...
			switch(odr) {
			case ORDER::FIRST:
				// SCL1: P21 (LFQFP64: ) (LFQFP100:  )
				// SDA1: P20 (LFQFP64: ) (LFQFP100:  )
				PORT2::PMR.B1 = 0;
		...
		static bool rspi1_(ORDER odr, bool enable) noexcept
		{
			...
			switch(odr) {
			case ORDER::FIRST:
				// RSPCKB: P27 (LFQFP64: ) (LFQFP100:  )
				// MOSIB:  P26 (LFQFP64: ) (LFQFP100:  )
				// MISOB:  P30 (LFQFP64: ) (LFQFP100:  )
				PORT2::PMR.B7 = 0;
				MPC::P27PFS.PSEL = sel;  // ok
				PORT2::PMR.B7 = enable;
				PORT2::PMR.B6 = 0;
				...
				break;
			case ORDER::SECOND:
				// RSPCKA: P27 (LFQFP64: ) (LFQFP100:  )
				// MOSIA:  PE6 (LFQFP64: ) (LFQFP100:  )
				// MISOA:  PE7 (LFQFP64: ) (LFQFP100:  )
				PORT2::PMR.B7 = 0;
				MPC::P27PFS.PSEL = sel;  // ok
				PORT2::PMR.B7 = enable;
				PORTE::PMR.B6 = 0;
