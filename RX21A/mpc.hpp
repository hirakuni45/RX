...
//=========================================================================//
/*!	@file
	@brief	Multi-Function Pin Controller / マルチファンクションピンコントローラ (RX21A)
	...
	*/
	...
	struct mpc_t {
		...
		*/
		...
		//+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++//
		/*!
			@brief  P4n 端子機能制御レジスタ（P4nPFS）（n = 0 ～ 3）
		*/
		//+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++//
		...
		//+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++//
		/*!
			@brief  P5n 端子機能制御レジスタ（P5nPFS）（n = 0 ～ 2, 4, 5）
		*/
		//+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++//
		...
		*/
		//+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++//
		static inline pfs_aip_t<0x0008'C198> PB0PFS;
		static inline pfs_aip_t<0x0008'C199> PB1PFS;
		static inline pfs_aip_t<0x0008'C19A> PB2PFS;
		static inline pfs_aip_t<0x0008'C19B> PB3PFS;
		static inline pfs_aip_t<0x0008'C19C> PB4PFS;
		static inline pfs_aip_t<0x0008'C19D> PB5PFS;
		static inline pfs_aip_t<0x0008'C19E> PB6PFS;
		static inline pfs_aip_t<0x0008'C19F> PB7PFS;
		...
		*/
		...
		//+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++//
		/*!
			@brief  PEn 端子機能制御レジスタ（PEnPFS）（n = 6, 7）
		*/
		//+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++//
		static inline pfs_ip_t<0x0008'C1B6> PE6PFS;
		static inline pfs_ip_t<0x0008'C1B7> PE7PFS;
