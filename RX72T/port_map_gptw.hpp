...
namespace device {
	...
	*/
	...
	private:
		static bool gptw0_(CHANNEL ch, bool ena, bool neg, ORDER opt) noexcept
		{
			bool ret = true;
			uint8_t sel;
			switch(ch) {
		...
		static bool gptw1_(CHANNEL ch, bool ena, bool neg, ORDER opt) noexcept
		{
			bool ret = true;
			uint8_t sel;
			switch(ch) {
		...
		static bool gptw2_(CHANNEL ch, bool ena, bool neg, ORDER opt) noexcept
		{
			bool ret = true;
			uint8_t sel;
			switch(ch) {
		...
		static bool gptw3_(CHANNEL ch, bool ena, bool neg, ORDER opt) noexcept
		{
			bool ret = true;
			uint8_t sel;
			switch(ch) {
		...
		static bool gptw4_(CHANNEL ch, bool ena, bool neg, ORDER opt) noexcept
		{
			bool ret = true;
			uint8_t sel;
			switch(ch) {
		...
		static bool gptw5_(CHANNEL ch, bool ena, bool neg, ORDER opt) noexcept
		{
			bool ret = true;
			uint8_t sel;
			switch(ch) {
		...
		static bool gptw6_(CHANNEL ch, bool ena, bool neg, ORDER opt) noexcept
		{
			bool ret = true;
			uint8_t sel;
			switch(ch) {
		...
		static bool gptw7_(CHANNEL ch, bool ena, bool neg, ORDER opt) noexcept
		{
			bool ret = true;
		...
		static bool gptw8_(CHANNEL ch, bool ena, bool neg, ORDER opt) noexcept
		{
			bool ret = true;
			uint8_t sel = ena ? (neg ? 0b010111 : 0b010101) : 0;
			switch(ch) {
		...
		static bool gptw9_(CHANNEL ch, bool ena, bool neg, ORDER opt) noexcept
		{
			bool ret = true;
			uint8_t sel = ena ? (neg ? 0b010111 : 0b010101) : 0;
			switch(ch) {
	...
	public:
		...
		*/
		//+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++//
		static bool turn(peripheral per, CHANNEL ch, bool ena = true, bool neg = false, ORDER opt = ORDER::FIRST) noexcept
		{
