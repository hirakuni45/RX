...
※RX72T 特有の定義や設定を網羅しています。
   
C++ テンプレートを活用したハードウェアー定義は、C++17 準拠のコンパイラならエラー   
...
## プロジェクト・リスト
 - [R5F572TK リンカースクリプト (RAM:128K, ROM:1M)](R5F572TK.ld?ts=4)
 - [R5F572TE リンカースクリプト (RAM:128K, ROM:512K)](R5F572TE.ld?ts=4)
...
- USB を使わない場合は 200MHz (8MHzx25) で動作可能です。
- 上記二種類の場合に都合が良いクリスタルは 8MHz となります。
- サンプルでは、外部接続クリスタルは 8MHz を想定しています。
