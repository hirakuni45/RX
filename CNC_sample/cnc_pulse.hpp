...
namespace cnc {
	...
	*/
	...
	class pulse {
		...
		static constexpr uint8_t DIR_X_BIT     = 0b00000001;
		static constexpr uint8_t DIR_Y_BIT     = 0b00000010;
		static constexpr uint8_t DIR_Z_BIT     = 0b00000100;
		static constexpr uint8_t DIR_W_BIT     = 0b00001000;
		static constexpr uint8_t DIR_ALL_BITS  = 0b00001111;
		static constexpr uint8_t STEP_X_BIT    = 0b00010000;
		static constexpr uint8_t STEP_Y_BIT    = 0b00100000;
		static constexpr uint8_t STEP_Z_BIT    = 0b01000000;
		static constexpr uint8_t STEP_W_BIT    = 0b10000000;
		static constexpr uint8_t STEP_ALL_BITS = 0b11110000;
		static constexpr uint8_t LIM_X_BIT     = 0b00010000;
		static constexpr uint8_t LIM_Y_BIT     = 0b00100000;
		static constexpr uint8_t LIM_Z_BIT     = 0b01000000;
		static constexpr uint8_t LIM_W_BIT     = 0b10000000;
