	...
	*/
	...
	class port_map_mtu : public port_map_order {
		...
		static bool mtu2_(CHANNEL ch, bool ena, ORDER odr) noexcept
		{
			...
			// PB5 (LFQFP64: 35) (LFQFP100:  55)
			// PE0 (LFQFP64: 51) (LFQFP100:  78)
			// P50 (LFQFP64: --) (LFQFP100:  42)
				switch(odr) {
				case ORDER::FIRST:
					PORT2::PMR.B6 = 0;
			...
			// PA4 (LFQFP64: 42) (LFQFP100:  68)
			// PE5 (LFQFP64: 46) (LFQFP100:  73)
			// P53 (LFQFP64: --) (LFQFP100:  39)
				switch(odr) {
				case ORDER::FIRST:
					PORT2::PMR.B7 = 0;
		...
		static bool mtu4_(CHANNEL ch, bool ena, ORDER odr) noexcept
		{
			...
			// PE5 (LFQFP64: 46) (LFQFP100:  73)
			// P25 (LFQFP64: --) (LFQFP100:   5)
			// P51 (LFQFP64: --) (LFQFP100:  41)
				switch(odr) {
				case ORDER::FIRST:
					PORTB::PMR.B1 = 0;
