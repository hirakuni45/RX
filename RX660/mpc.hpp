...
//=========================================================================//
/*!	@file
	@brief	Multi-Function Pin Controller / マルチファンクションピンコントローラ (RX660)
	...
	*/
	...
	struct mpc_t {
		...
		*/
		...
		//+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++//
		/*!
			@brief  P0n 端子機能制御レジスタ（P0nPFS）（n = 0 ～ 7）
		*/
		//+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++//
		...
		static inline pfs_pia_t<0x0008'C144> P04PFS;
		static inline pfs_pia_t<0x0008'C145> P05PFS;
		static inline pfs_pia_t<0x0008'C146> P06PFS;
		...
		*/
		...
		//+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++//
		/*!
			@brief  P3n 端子機能制御レジスタ（P3nPFS）（n = 0 ～ 7）
		*/
		//+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++//
		...
		static inline pfs_pi_t<0x0008'C15D> P35PFS;
		static inline pfs_pi_t<0x0008'C15E> P36PFS;
		static inline pfs_pi_t<0x0008'C15F> P37PFS;
		...
		*/
		...
		static inline pfs_pi_t<0x0008'C16B> P53PFS;
		...
		*/
		...
		static inline pfs_pi_t<0x0008'C175> P65PFS;
		...
		*/
		//+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++//
		static inline pfs_pi_t<0x0008'C178> P70PFS;
		static inline pfs_pi_t<0x0008'C179> P71PFS;
		static inline pfs_pi_t<0x0008'C17A> P72PFS;
		static inline pfs_pi_t<0x0008'C17B> P73PFS;
		static inline pfs_pi_t<0x0008'C17C> P74PFS;
		static inline pfs_pi_t<0x0008'C17D> P75PFS;
		static inline pfs_pi_t<0x0008'C17E> P76PFS;
		static inline pfs_pi_t<0x0008'C17F> P77PFS;
		...
		*/
		//+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++//
		static inline pfs_pi_t<0x0008'C180> P80PFS;
		static inline pfs_pi_t<0x0008'C181> P81PFS;
		static inline pfs_pi_t<0x0008'C182> P82PFS;
		static inline pfs_pi_t<0x0008'C183> P83PFS;
		static inline pfs_pi_t<0x0008'C186> P86PFS;
		static inline pfs_pi_t<0x0008'C187> P87PFS;
		...
		*/
		//+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++//
		static inline pfs_pia_t<0x0008'C188> P90PFS;
		static inline pfs_pia_t<0x0008'C189> P91PFS;
		static inline pfs_pia_t<0x0008'C18A> P92PFS;
		static inline pfs_pia_t<0x0008'C18B> P93PFS;
		...
		*/
		...
		//+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++//
		/*!
			@brief  PFn 端子機能制御レジスタ（PFnPFS）（n = 5 ～ 7）
		*/
		//+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++//
		static inline pfs_pi_t<0x0008'C1BD> PF5PFS;
		static inline pfs_pi_t<0x0008'C1BE> PF6PFS;
		static inline pfs_pi_t<0x0008'C1BF> PF7PFS;


		//+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++//
		/*!
			@brief  PHn 端子機能制御レジスタ（PHnPFS）（n = 0 ～ 3, 6, 7）
		*/
		//+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++//
		static inline pfs_pi_t<0x0008'C1C8> PH0PFS;
		static inline pfs_pi_t<0x0008'C1C9> PH1PFS;
		static inline pfs_pi_t<0x0008'C1CA> PH2PFS;
		static inline pfs_pi_t<0x0008'C1CB> PH3PFS;
		static inline pfs_pi_t<0x0008'C1CE> PH6PFS;
		static inline pfs_pi_t<0x0008'C1CF> PH7PFS;


		//+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++//
		/*!
			@brief  PJn 端子機能制御レジスタ（PJnPFS）（n = 1, 3 ～ 7）
		*/
		//+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++//
		static inline pfs_pi_t<0x0008'C1D1> PJ1PFS;
		static inline pfs_pi_t<0x0008'C1D3> PJ3PFS;
		static inline pfs_pi_t<0x0008'C1D4> PJ4PFS;
		static inline pfs_pi_t<0x0008'C1D5> PJ5PFS;
		static inline pfs_pi_t<0x0008'C1D6> PJ6PFS;
		static inline pfs_pi_t<0x0008'C1D7> PJ7PFS;


		//+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++//
		/*!
			@brief  PKn 端子機能制御レジスタ（PKnPFS）（n = 2 ～ 5）
		*/
		//+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++//
