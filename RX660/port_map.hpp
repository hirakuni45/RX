	...
	class port_map : public port_map_order {
		...
		static bool sci0_(ORDER odr, bool enable, OPTIONAL opt) noexcept
		{
			...
			case ORDER::FIRST:
				...
				break;
			case ORDER::SECOND:
				// RXD0: P33 (LFQFP144:  26)
				// TXD0: P32 (LFQFP144:  27)
				// SCK0: P34 (LFQFP144:  25)
		...
		static bool sci1_(ORDER odr, bool enable, OPTIONAL opt) noexcept
		{
			...
			switch(odr) {
			case ORDER::FIRST:
				// RXD1: P15 (LFQFP144:  42)
				// TXD1: P16 (LFQFP144:  40)
				// SCK1: P17 (LFQFP144:  38)
				sel = enable ? 0b00'1010 : 0;  // ok
				PORT1::PMR.B5 = 0;
				PORT1::PDR.B5 = i2c;
				MPC::P15PFS.PSEL = sel;
				...
				break;
			case ORDER::SECOND:
				// RXD1: P30 (LFQFP144:  29)
				// TXD1: P26 (LFQFP144:  31)
				// SCK1: P27 (LFQFP144:  30)
				sel = enable ? 0b00'1010 : 0;  // ok
				PORT3::PMR.B0 = 0;
				PORT3::ODR.B0 = i2c;
				MPC::P30PFS.PSEL = sel;
		...
		static bool sci2_(ORDER odr, bool enable, OPTIONAL opt) noexcept
		{
			...
			switch(odr) {
			case ORDER::FIRST:
				// RXD2: P12 (LFQFP144:  45)
				// TXD2: P13 (LFQFP144:  44)
				// SCK2: P51 (LFQFP144:  55)
				sel = enable ? 0b00'1010 : 0;  // ok
				PORT1::PMR.B2 = 0;
				PORT1::ODR.B2 = i2c;
				MPC::P12PFS.PSEL = sel;
				...
				break;
			case ORDER::SECOND:
				// RXD2: P52 (LFQFP144:  54)
				// TXD2: P50 (LFQFP144:  56)
				// SCK2: P51 (LFQFP144:  55)
				sel = enable ? 0b00'1010 : 0;  // ok
				PORT5::PMR.B2 = 0;
				PORT5::ODR.B2 = i2c;
		...
		static bool sci3_(ORDER odr, bool enable, OPTIONAL opt) noexcept
		{
			...
			switch(odr) {
			case ORDER::FIRST:
				// RXD3: P16 (LFQFP144:  40)
				// TXD3: P17 (LFQFP144:  38)
				// SCK3: P15 (LFQFP144:  42)
				sel = enable ? 0b00'1011 : 0;  // ok
				PORT1::PMR.B6 = 0;
				PORT1::ODR.B6 = i2c;
				MPC::P16PFS.PSEL = sel;
				...
				break;
			case ORDER::SECOND:
				// RXD3: P25 (LFQFP144:  32)
				// TXD3: P23 (LFQFP144:  34)
				// SCK3: P24 (LFQFP144:  33)
				sel = enable ? 0b00'1010 : 0;  // ok
				PORT2::PMR.B5 = 0;
				PORT2::ODR.B5 = i2c;
				MPC::P25PFS.PSEL = sel;
		...
		static bool sci4_(ORDER odr, bool enable, OPTIONAL opt) noexcept
		{
			...
			switch(odr) {
			case ORDER::FIRST:
				// RXD4: PB0 (LFQFP144:  87)
				// TXD4: PB1 (LFQFP144:  84)
				// SCK4: PB3 (LFQFP144:  82)
				PORTB::PMR.B0 = 0;
				PORTB::ODR.B0 = i2c;
				MPC::PB0PFS.PSEL = sel;
				PORTB::PMR.B0 = enable;
		...
		static bool sci5_(ORDER odr, bool enable, OPTIONAL opt) noexcept
		{
			...
			switch(odr) {
			case ORDER::FIRST:
				// RXD5: PA2 (LFQFP144:  95)
				// TXD5: PA4 (LFQFP144:  92)
				// SCK5: PA1 (LFQFP144:  96)
				sel = enable ? 0b00'1010 : 0;  // ok
				PORTA::PMR.B2 = 0;
				PORTA::ODR.B2 = i2c;
				MPC::PA2PFS.PSEL = sel;
		...
		static bool sci6_(ORDER odr, bool enable, OPTIONAL opt) noexcept
		{
			...
			case ORDER::FIRST:
				...
				break;
			case ORDER::SECOND:
				// RXD6: P33 (LFQFP144:  26)
				// TXD6: P32 (LFQFP144:  27)
				// SCK6: P34 (LFQFP144:  25)
				sel = enable ? 0b0'1010 : 0;  // ok
				PORT3::PMR.B3 = 0;
				PORT3::ODR.B3 = i2c;
				MPC::P33PFS.PSEL = sel;
				...
				break;
			case ORDER::THIRD:
				// RXD6: PB0 (LFQFP144:  87)
				// TXD6: PB1 (LFQFP144:  84)
				// SCK6: PB3 (LFQFP144:  82)
				sel = enable ? 0b00'1011 : 0;  // ok
				PORTB::PMR.B1 = 0;
				PORTB::ODR.B1 = i2c;
				MPC::PB1PFS.PSEL = sel;
		...
		static bool sci7_(ORDER odr, bool enable, OPTIONAL opt) noexcept
		{
			...
			switch(odr) {
			case ORDER::FIRST:
				// RXD7: P92 (LFQFP144: 128)
				// TXD7: P90 (LFQFP144: 131)
				// SCK7: P91 (LFQFP144: 129)
			...
			case ORDER::SECOND:
				// RXD7: P92 (LFQFP144: 128)
				// TXD7: P55 (LFQFP144:  51)
				// SCK7: P56 (LFQFP144:  50)
				sel = enable ? 0b00'1010 : 0;  // ok
				PORT9::PMR.B2 = 0;
				PORT9::ODR.B2 = i2c;
				MPC::P92PFS.PSEL = sel;
		...
		static bool sci8_(ORDER odr, bool enable, OPTIONAL opt) noexcept
		{
			...
			switch(odr) {
			case ORDER::FIRST:
				// RXD8: PC6 (LFQFP144:  61)
				// TXD8: PC7 (LFQFP144:  60)
				// SCK8: PC5 (LFQFP144:  62)
				sel = enable ? 0b00'1010 : 0;  // ok
				PORTC::PMR.B6 = 0;
				PORTC::ODR.B6 = i2c;
				MPC::PC6PFS.PSEL = sel;
		...
		static bool sci9_(ORDER odr, bool enable, OPTIONAL opt) noexcept
		{
			...
			switch(odr) {
			case ORDER::FIRST:
				// RXD9: PB6 (LFQFP144:  79)
				// TXD9: PB7 (LFQFP144:  78)
				// SCK9: PB5 (LFQFP144:  80)
				sel = enable ? 0b00'1010 : 0;  // ok
				PORTB::PMR.B6 = 0;
				PORTB::ODR.B6 = i2c;
				MPC::PB6PFS.PSEL = sel;
		...
		static bool sci10_(ORDER odr, bool enable, OPTIONAL opt) noexcept
		{
			...
			switch(odr) {
			case ORDER::FIRST:
				// RXD10: P81 (LFQFP144:  64)
				// TXD10: P82 (LFQFP144:  63)
				// SCK10: P80 (LFQFP144:  65)
				sel = enable ? 0b00'1010 : 0;
				PORTB::PMR.B1 = 0;
				PORTB::ODR.B1 = i2c;
				MPC::PB1PFS.PSEL = sel;
				...
				break;
			case ORDER::SECOND:
				// RXD10: P86 (LFQFP144:  41)
				// TXD10: P87 (LFQFP144:  39)
				// SCK10: P83 (LFQFP144:  58)
				sel = enable ? 0b00'1010 : 0;  // ok
				PORT8::PMR.B6 = 0;
				PORT8::ODR.B6 = i2c;
				MPC::P86PFS.PSEL = sel;
				...
				break;
			case ORDER::THIRD:
				// RXD10: PC6 (LFQFP144:  61)
				// TXD10: PC7 (LFQFP144:  60)
				// SCK10: PC5 (LFQFP144:  62)
		...
		static bool sci11_(ORDER odr, bool enable, OPTIONAL opt) noexcept
		{
			...
			switch(odr) {
			case ORDER::FIRST:
				// RXD11: P76 (LFQFP144:  69)
				// TXD11: P77 (LFQFP144:  68)
				// SCK11: P75 (LFQFP144:  71)
				sel = enable ? 0b00'1010 : 0;  // ok
				PORT7::PMR.B6 = 0;
				PORT7::ODR.B6 = i2c;
				MPC::P76PFS.PSEL = sel;
				...
				break;
			case ORDER::SECOND:
				// RXD11: PB6 (LFQFP144:  79)
				// TXD11: PB7 (LFQFP144:  78)
				// SCK11: PB5 (LFQFP144:  80)
		...
		static bool sci12_(ORDER odr, bool enable, OPTIONAL opt) noexcept
		{
			...
			switch(odr) {
			case ORDER::FIRST:
				// RXD12: PE2 (LFQFP144: 109)
				// TXD12: PE1 (LFQFP144: 110)
				// SCK12: PE0 (LFQFP144: 111)
				...
				break;
			case ORDER::SECOND:
				// RXD12: PA2 (LFQFP144:  95)
				// TXD12: PA4 (LFQFP144:  92)
				// SCK12: PA1 (LFQFP144:  96)
				sel = enable ? 0b00'1010 : 0;  // ok
				PORTA::PMR.B2 = 0;
				PORTA::ODR.B2 = i2c;
				MPC::PA2PFS.PSEL = sel;
		...
		static bool rsci10_(ORDER odr, bool enable, OPTIONAL opt) noexcept
		{
			...
			switch(odr) {
			case ORDER::FIRST:
				// RXD010: P81 (LFQFP144:  64)
				// TXD010: P82 (LFQFP144:  63)
				// SCK010: P80 (LFQFP144:  65)
				PORT8::PMR.B1 = 0;
				PORT8::ODR.B1 = i2c;
				...
				break;
			case ORDER::SECOND:
				// RXD010: P86 (LFQFP144:  41)
				// TXD010: P87 (LFQFP144:  39)
				// SCK010: P83 (LFQFP144:  58)
				PORT8::PMR.B6 = 0;
				PORT8::ODR.B6 = i2c;
				...
				break;
			case ORDER::THIRD:
				// RXD010: PC6 (LFQFP144:  61)
				// TXD010: PC7 (LFQFP144:  60)
				// SCK010: PC5 (LFQFP144:  62)
				PORTC::PMR.B6 = 0;
				PORTC::ODR.B6 = i2c;
		...
		static bool rsci11_(ORDER odr, bool enable, OPTIONAL opt) noexcept
		{
			...
			switch(odr) {
			case ORDER::FIRST:
				// RXD011: P76 (LFQFP144:  69)
				// TXD011: P77 (LFQFP144:  68)
				// SCK011: P75 (LFQFP144:  71)
				PORT7::PMR.B6 = 0;
				PORT7::ODR.B6 = i2c;
				...
				break;
			case ORDER::SECOND:
				// RXD011: PB6 (LFQFP144:  79)
				// TXD011: PB7 (LFQFP144:  78)
				// SCK011: PB5 (LFQFP144:  80)
				PORTB::PMR.B6 = 0;
				PORTB::ODR.B6 = i2c;
				...
				break;
			case ORDER::THIRD:
				// RXD011: PC0 (LFQFP144:  75)
				// TXD011: PC1 (LFQFP144:  73)
				// SCK011: PB5 (LFQFP144:  80)
				PORTC::PMR.B0 = 0;
				PORTC::ODR.B0 = i2c;
		...
		static bool riic2_(ORDER odr, bool enable) noexcept
		{
			...
			switch(odr) {
			case ORDER::FIRST:
				// SCL2: P16 (LFQFP144:  40)
				// SDA2: P17 (LFQFP144:  38)
				PORT1::PMR.B6 = 0;
		...
		static bool canfd0_(ORDER odr, bool enable) noexcept
		{
			...
			switch(odr) {
			case ORDER::FIRST:
				// CRX0: P15 (LFQFP144:  42)
				// CTX0: P14 (LFQFP144:  43)
				PORT1::PMR.B5 = 0;
			...
			case ORDER::SECOND:
				...
				break;
			case ORDER::THIRD:
				// CRX0: P55 (LFQFP144:  51)
				// CTX0: P54 (LFQFP144:  52)
				PORT5::PMR.B5 = 0;
				...
				break;
			case ORDER::FOURTH:
				// CRX0: PD2 (LFQFP144: 124)
				// CTX0: PD1 (LFQFP144: 125)
				PORTD::PMR.B2 = 0;
		...
		static bool rspi0_(ORDER odr, bool enable) noexcept
		{
			...
			switch(odr) {
			case ORDER::FIRST:
				// RSPCKA: PA5 (LFQFP144:  90)
				// MOSIA:  PA6 (LFQFP144:  89)
				// MISOA:  PA7 (LFQFP144:  88)
				PORTA::PMR.B5 = 0;
				MPC::PA5PFS.PSEL = sel;
				PORTA::PMR.B5 = enable;
				PORTA::PMR.B6 = 0;
				...
				break;
			case ORDER::SECOND:
				// RSPCKA: PC5 (LFQFP144:  62)
				// MOSIA:  PC6 (LFQFP144:  61)
				// MISOA:  PC7 (LFQFP144:  60)
				PORTC::PMR.B5 = 0;
				MPC::PC5PFS.PSEL = sel;
				PORTC::PMR.B5 = enable;
				PORTC::PMR.B6 = 0;
